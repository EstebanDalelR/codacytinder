...
class MessageThreadUtil<T> implements ThreadUtil<T> {
    ...
    public MainThreadCallback<T> getMainThreadProxy(final MainThreadCallback<T> mainThreadCallback) {
        return new MainThreadCallback<T>() {
            ...
            private Runnable mMainThreadRunnable = new C06751();
            ...
            class C06751 implements Runnable {
                ...
                public void run() {
                    SyncQueueItem next = C29241.this.mQueue.next();
                    while (next != null) {
                        switch (next.what) {
                            case 1:
    ...
    public BackgroundCallback<T> getBackgroundProxy(final BackgroundCallback<T> backgroundCallback) {
        return new BackgroundCallback<T>() {
            ...
            private Runnable mBackgroundRunnable = new C06761();
            ...
            class C06761 implements Runnable {
                ...
                public void run() {
                    while (true) {
                        SyncQueueItem next = C29252.this.mQueue.next();
                        if (next != null) {
                            switch (next.what) {
                                case 1:
                                    C29252.this.mQueue.removeMessages(1);
                                    backgroundCallback.refresh(next.arg1);
                                    break;
                                case 2:
                                    C29252.this.mQueue.removeMessages(2);
                                    C29252.this.mQueue.removeMessages(3);
                        ...
                        C29252.this.mBackgroundRunning.set(false);
                        return;
                    }
                }
            }
