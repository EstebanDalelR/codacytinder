...
public class AsyncListUtil<T> {
    ...
    private final BackgroundCallback<T> mBackgroundCallback = new C29232();
    final BackgroundCallback<T> mBackgroundProxy;
    final DataCallback<T> mDataCallback;
    int mDisplayedGeneration = 0;
    int mItemCount = 0;
    private final MainThreadCallback<T> mMainThreadCallback = new C29221();
    ...
    class C29221 implements MainThreadCallback<T> {
        C29221() {
        }
    ...
    class C29232 implements BackgroundCallback<T> {
