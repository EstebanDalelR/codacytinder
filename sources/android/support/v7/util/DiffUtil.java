...
public class DiffUtil {
    private static final Comparator<Snake> SNAKE_COMPARATOR = new C06741();

    /* renamed from: android.support.v7.util.DiffUtil$1 */
    static class C06741 implements Comparator<Snake> {
        C06741() {
        }

        public int compare(Snake snake, Snake snake2) {
            int i = snake.f2016x - snake2.f2016x;
            return i == 0 ? snake.f2017y - snake2.f2017y : i;
        }
    }
    ...
    public static class DiffResult {
        ...
        private void addRootSnake() {
            ...
            if (snake == null || snake.f2016x != 0 || snake.f2017y != 0) {
                snake = new Snake();
                snake.f2016x = 0;
                snake.f2017y = 0;
                snake.removal = false;
        ...
        private void findMatchingItems() {
            ...
            for (int size = this.mSnakes.size() - 1; size >= 0; size--) {
                ...
                int i3 = snake.f2016x + snake.size;
                int i4 = snake.f2017y + snake.size;
        ...
        private boolean findMatchingItem(int i, int i2, int i3, boolean z) {
            ...
            while (i3 >= 0) {
                ...
                int i6 = snake.f2016x + snake.size;
                int i7 = snake.f2017y + snake.size;
                int i8 = 4;
                if (z) {
                    for (i4--; i4 >= i6; i4--) {
        ...
        public void dispatchUpdatesTo(ListUpdateCallback listUpdateCallback) {
            ...
            for (int size = this.mSnakes.size() - 1; size >= 0; size--) {
                Snake snake = (Snake) this.mSnakes.get(size);
                int i3 = snake.size;
                int i4 = snake.f2016x + i3;
                int i5 = snake.f2017y + i3;
                if (i4 < i) {
                ...
                for (i3--; i3 >= 0; i3--) {
                    if ((this.mOldItemStatuses[snake.f2016x + i3] & 31) == 2) {
                        listUpdateCallback.onChanged(snake.f2016x + i3, 1, this.mCallback.getChangePayload(snake.f2016x + i3, snake.f2017y + i3));
                    }
                }
                i = snake.f2016x;
                i2 = snake.f2017y;
    ...
    public static DiffResult calculateDiff(Callback callback, boolean z) {
        ...
        while (!arrayList2.isEmpty()) {
            ...
            if (diffPartial != null) {
                ...
                diffPartial.f2016x += range.oldListStart;
                diffPartial.f2017y += range.newListStart;
                Range range2 = arrayList3.isEmpty() ? new Range() : (Range) arrayList3.remove(arrayList3.size() - 1);
                range2.oldListStart = range.oldListStart;
                range2.newListStart = range.newListStart;
                if (diffPartial.reverse) {
                    range2.oldListEnd = diffPartial.f2016x;
                    range2.newListEnd = diffPartial.f2017y;
                } else if (diffPartial.removal) {
                    range2.oldListEnd = diffPartial.f2016x - 1;
                    range2.newListEnd = diffPartial.f2017y;
                } else {
                    range2.oldListEnd = diffPartial.f2016x;
                    range2.newListEnd = diffPartial.f2017y - 1;
                }
                arrayList2.add(range2);
                if (!diffPartial.reverse) {
                    range.oldListStart = diffPartial.f2016x + diffPartial.size;
                    range.newListStart = diffPartial.f2017y + diffPartial.size;
                } else if (diffPartial.removal) {
                    range.oldListStart = (diffPartial.f2016x + diffPartial.size) + 1;
                    range.newListStart = diffPartial.f2017y + diffPartial.size;
                } else {
                    range.oldListStart = diffPartial.f2016x + diffPartial.size;
                    range.newListStart = (diffPartial.f2017y + diffPartial.size) + 1;
                }
                    ...
                    while (i17 <= i12) {
                        if (i17 != i16) {
                            ...
                            if (obj != null || i17 < (i9 - i12) + 1 || i17 > (i9 + i12) - 1 || iArr3[i6] < iArr4[i6]) {
                                ...
                                snake = new Snake();
                                snake.f2016x = iArr4[i6];
                                snake.f2017y = snake.f2016x - i17;
                    ...
                    for (i7 = i16; i7 <= i12; i7 += 2) {
                        ...
                        if (i8 != i12 + i9) {
                            ...
                            if (obj == null || i8 < i16 || i8 > i12 || iArr3[i19] < iArr4[i19]) {
                                ...
                                snake = new Snake();
                                snake.f2016x = iArr4[i19];
                                snake.f2017y = snake.f2016x - i8;
