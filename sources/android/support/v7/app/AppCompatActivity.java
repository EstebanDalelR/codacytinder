...
public class AppCompatActivity extends FragmentActivity implements SupportParentable, DelegateProvider, AppCompatCallback {
    ...
    public void onCreateSupportNavigateUpTaskStack(@NonNull TaskStackBuilder taskStackBuilder) {
        taskStackBuilder.m1441a((Activity) this);
    }
...
*/
    ...
    L_0x000c:
        r0 = android.support.v4.app.TaskStackBuilder.m1440a(r2);
        r2.onCreateSupportNavigateUpTaskStack(r0);
        r2.onPrepareSupportNavigateUpTaskStack(r0);
        r0.m1444a();
        android.support.v4.app.ActivityCompat.m10973a(r2);	 Catch:{ IllegalStateException -> 0x001d }
        goto L_0x0024;
    L_0x001d:
        r2.finish();
        goto L_0x0024;
    ...
    public Intent getSupportParentActivityIntent() {
        return C0420r.m1566a(this);
    }

    public boolean supportShouldUpRecreateTask(@NonNull Intent intent) {
        return C0420r.m1568a((Activity) this, intent);
    }

    public void supportNavigateUpTo(@NonNull Intent intent) {
        C0420r.m1571b((Activity) this, intent);
    }
