...
public class WindowDecorActionBar extends ActionBar implements ActionBarVisibilityCallback {
    ...
    final ViewPropertyAnimatorListener mHideListener = new C40431();
    ...
    final ViewPropertyAnimatorListener mShowListener = new C40442();
    private boolean mShowingForMode;
    ScrollingTabContainerView mTabScrollView;
    private ArrayList<TabImpl> mTabs = new ArrayList();
    private Context mThemedContext;
    final ViewPropertyAnimatorUpdateListener mUpdateListener = new C29203();

    /* renamed from: android.support.v7.app.WindowDecorActionBar$3 */
    class C29203 implements ViewPropertyAnimatorUpdateListener {
        C29203() {
        }
    ...
    class C40431 extends C2899o {
        ...
        public void onAnimationEnd(View view) {
            ...
            if (WindowDecorActionBar.this.mOverlayLayout != null) {
                ViewCompat.m2226r(WindowDecorActionBar.this.mOverlayLayout);
            }
        }
    }

    /* renamed from: android.support.v7.app.WindowDecorActionBar$2 */
    class C40442 extends C2899o {
        C40442() {
        }
    ...
    private void init(View view) {
        this.mOverlayLayout = (ActionBarOverlayLayout) view.findViewById(C0667R.id.decor_content_parent);
        if (this.mOverlayLayout != null) {
            this.mOverlayLayout.setActionBarVisibilityCallback(this);
        }
        this.mDecorToolbar = getDecorToolbar(view.findViewById(C0667R.id.action_bar));
        this.mContextView = (ActionBarContextView) view.findViewById(C0667R.id.action_context_bar);
        this.mContainerView = (ActionBarContainer) view.findViewById(C0667R.id.action_bar_container);
            ...
            if (this.mContainerView != null) {
                ...
                if (!actionBarPolicy.enableHomeButtonByDefault()) {
                    if (view == null) {
                        ...
                        view = this.mContext.obtainStyledAttributes(null, C0667R.styleable.ActionBar, C0667R.attr.actionBarStyle, 0);
                        if (view.getBoolean(C0667R.styleable.ActionBar_hideOnContentScroll, false)) {
                            setHideOnContentScrollEnabled(true);
                        }
                        dimensionPixelSize = view.getDimensionPixelSize(C0667R.styleable.ActionBar_elevation, 0);
    ...
    private DecorToolbar getDecorToolbar(View view) {
        ...
        throw new IllegalStateException(stringBuilder.toString() != null ? view.getClass().getSimpleName() : ManagerWebServices.NULL_STRING_VALUE);
    }

    public void setElevation(float f) {
        ViewCompat.m2215i(this.mContainerView, f);
    }

    public float getElevation() {
        return ViewCompat.m2223o(this.mContainerView);
    }
    ...
    private void setHasEmbeddedTabs(boolean z) {
        ...
        if (this.mTabScrollView != null) {
            if (z) {
                ...
                if (this.mOverlayLayout != null) {
                    ViewCompat.m2226r(this.mOverlayLayout);
                }
            } else {
    ...
    public void selectTab(Tab tab) {
        ...
        C0405n a = (!(this.mActivity instanceof FragmentActivity) || this.mDecorToolbar.getViewGroup().isInEditMode()) ? null : ((FragmentActivity) this.mActivity).getSupportFragmentManager().mo429a().mo399a();
        if (this.mSelectedTab != tab) {
            ...
            if (this.mSelectedTab != null) {
                this.mSelectedTab.getCallback().onTabUnselected(this.mSelectedTab, a);
            }
            this.mSelectedTab = (TabImpl) tab;
            if (this.mSelectedTab != null) {
                this.mSelectedTab.getCallback().onTabSelected(this.mSelectedTab, a);
            }
        } else if (this.mSelectedTab != null) {
            this.mSelectedTab.getCallback().onTabReselected(this.mSelectedTab, a);
            this.mTabScrollView.animateToTab(tab.getPosition());
        }
        if (a != null && a.mo421i() == null) {
            a.mo410c();
        }
    }
    ...
    L_0x0039:
        ...
        r5.<init>();
        r2 = r4.mContainerView;
        r2 = android.support.v4.view.ViewCompat.m2221m(r2);
        r2 = r2.m2382b(r1);
    ...
    L_0x005d:
        ...
        r0 = r4.mContentView;
        r0 = android.support.v4.view.ViewCompat.m2221m(r0);
        r0 = r0.m2382b(r1);
        r5.play(r0);
    L_0x006f:
    ...
    L_0x00a7:
        r5 = r4.mOverlayLayout;
        android.support.v4.view.ViewCompat.m2226r(r5);
    L_0x00ac:
        return;
        */
    ...
    L_0x003e:
        r5 = r4.mContainerView;
        r5 = android.support.v4.view.ViewCompat.m2221m(r5);
        r5 = r5.m2382b(r2);
    ...
    public void animateToMode(boolean z) {
        ...
        if (shouldAnimateContextView()) {
            ...
            if (z) {
                ...
                c0609n = this.mContextView.setupAnimatorToVisibility(0, FADE_IN_DURATION_MS);
            } else {
                c0609n = this.mDecorToolbar.setupAnimatorToVisibility(0, FADE_IN_DURATION_MS);
                z = this.mContextView.setupAnimatorToVisibility(8, FADE_OUT_DURATION_MS);
            }
            ViewPropertyAnimatorCompatSet viewPropertyAnimatorCompatSet = new ViewPropertyAnimatorCompatSet();
            viewPropertyAnimatorCompatSet.playSequentially(z, c0609n);
    ...
    private boolean shouldAnimateContextView() {
        return ViewCompat.m2234z(this.mContainerView);
    }

    public Context getThemedContext() {
        if (this.mThemedContext == null) {
            TypedValue typedValue = new TypedValue();
            this.mContext.getTheme().resolveAttribute(C0667R.attr.actionBarWidgetTheme, typedValue, true);
