...
public abstract class ActionBar {
    ...
    public static class LayoutParams extends MarginLayoutParams {
        ...
        public LayoutParams(@NonNull Context context, AttributeSet attributeSet) {
            ...
            this.gravity = 0;
            context = context.obtainStyledAttributes(attributeSet, C0667R.styleable.ActionBarLayout);
            this.gravity = context.getInt(C0667R.styleable.ActionBarLayout_android_layout_gravity, 0);
            context.recycle();
        }
    ...
    public interface TabListener {
        void onTabReselected(Tab tab, C0405n c0405n);

        void onTabSelected(Tab tab, C0405n c0405n);

        void onTabUnselected(Tab tab, C0405n c0405n);
    }
