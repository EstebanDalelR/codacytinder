...
class TwilightManager {
    ...
    private Location getLastKnownLocation() {
        ...
        Location lastKnownLocationForProvider = PermissionChecker.m1637a(this.mContext, "android.permission.ACCESS_COARSE_LOCATION") == 0 ? getLastKnownLocationForProvider("network") : null;
        if (PermissionChecker.m1637a(this.mContext, "android.permission.ACCESS_FINE_LOCATION") == 0) {
    ...
    private void updateState(@NonNull Location location) {
        ...
        if (j5 != -1) {
            if (j2 != -1) {
                j = currentTimeMillis > j2 ? j6 + 0 : currentTimeMillis > j5 ? j2 + 0 : j5 + 0;
                j += 60000;
