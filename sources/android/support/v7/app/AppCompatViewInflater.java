...
public class AppCompatViewInflater {
    ...
    private static final Map<String, Constructor<? extends View>> sConstructorMap = new C2880a();
...
*/
    ...
    private void checkOnClickListener(View view, AttributeSet attributeSet) {
        ...
        if (context instanceof ContextWrapper) {
            if (VERSION.SDK_INT < 15 || ViewCompat.m2172D(view)) {
...
*/
    ...
    private static Context themifyContext(Context context, AttributeSet attributeSet, boolean z, boolean z2) {
        attributeSet = context.obtainStyledAttributes(attributeSet, C0667R.styleable.View, 0, 0);
        int resourceId = z ? attributeSet.getResourceId(C0667R.styleable.View_android_theme, 0) : false;
        if (z2 && !resourceId != false) {
            resourceId = attributeSet.getResourceId(C0667R.styleable.View_theme, 0);
            if (resourceId == true) {
