...
public class ActionBarDrawerToggle implements DrawerListener {
    ...
    ActionBarDrawerToggle(Activity activity, Toolbar toolbar, DrawerLayout drawerLayout, DrawerArrowDrawable drawerArrowDrawable, @StringRes int i, @StringRes int i2) {
        ...
        if (toolbar != null) {
            ...
            toolbar.setNavigationOnClickListener(new C06521());
    ...
    public void syncState() {
        if (this.mDrawerLayout.m2480f(8388611)) {
            setPosition(1.0f);
        } else {
            setPosition(0.0f);
        }
        if (this.mDrawerIndicatorEnabled) {
            setActionBarUpIndicator(this.mSlider, this.mDrawerLayout.m2480f(8388611) ? this.mCloseDrawerContentDescRes : this.mOpenDrawerContentDescRes);
        }
    }
    ...
    void toggle() {
        int a = this.mDrawerLayout.m2455a(8388611);
        if (this.mDrawerLayout.m2482g(8388611) && a != 2) {
            this.mDrawerLayout.m2479e(8388611);
        } else if (a != 1) {
            this.mDrawerLayout.m2477d(8388611);
        }
    }
