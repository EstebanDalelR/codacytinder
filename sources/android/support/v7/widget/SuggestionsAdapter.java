...
import android.support.v4.widget.C4039m;
...
class SuggestionsAdapter extends C4039m implements OnClickListener {
    ...
    private static final class ChildViewCache {
        ...
        public ChildViewCache(View view) {
            ...
            this.mIconRefine = (ImageView) view.findViewById(C0667R.id.edit_query);
        }
    }
    ...
    public View newView(Context context, Cursor cursor, ViewGroup viewGroup) {
        ...
        ((ImageView) context.findViewById(C0667R.id.edit_query)).setImageResource(this.mCommitIconResId);
        return context;
    }
    ...
    private CharSequence formatUrl(CharSequence charSequence) {
        if (this.mUrlColor == null) {
            ...
            this.mContext.getTheme().resolveAttribute(C0667R.attr.textColorSearchUrl, typedValue, true);
...
*/
    ...
    L_0x003c:
        r3 = r4.mProviderContext;	 Catch:{ NumberFormatException -> 0x005d, NotFoundException -> 0x0046 }
        r1 = android.support.v4.content.C0432b.m1640a(r3, r1);	 Catch:{ NumberFormatException -> 0x005d, NotFoundException -> 0x0046 }
...
*/
    ...
    L_0x0029:
        ...
        if (r1 != 0) goto L_0x004c;	 Catch:{ FileNotFoundException -> 0x0089 }
    L_0x0035:
        r1 = new java.io.FileNotFoundException;	 Catch:{ FileNotFoundException -> 0x0089 }
        r2 = new java.lang.StringBuilder;	 Catch:{ FileNotFoundException -> 0x0089 }
        r2.<init>();	 Catch:{ FileNotFoundException -> 0x0089 }
    ...
    private Drawable getActivityIcon(ComponentName componentName) {
        ...
        try {
            ActivityInfo activityInfo = packageManager.getActivityInfo(componentName, ProfileEditingConfig.DEFAULT_MAX_LENGTH);
...
*/
    ...
    L_0x000a:
        ...
        throw r0;
    L_0x0021:
        r1 = r7.mContext;	 Catch:{ NameNotFoundException -> 0x00ba }
        r1 = r1.getPackageManager();	 Catch:{ NameNotFoundException -> 0x00ba }
        r1 = r1.getResourcesForApplication(r0);	 Catch:{ NameNotFoundException -> 0x00ba }
    ...
    L_0x0050:
        r0 = r2.get(r4);	 Catch:{ NumberFormatException -> 0x005b }
    ...
    Cursor getSearchManagerSuggestions(SearchableInfo searchableInfo, String str, int i) {
        ...
        if (i > 0) {
            fragment.appendQueryParameter(ManagerWebServices.PARAM_LIMIT, String.valueOf(i));
        }
