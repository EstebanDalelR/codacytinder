...
class AppCompatBackgroundHelper {
    ...
    void loadFromAttributes(AttributeSet attributeSet, int i) {
        attributeSet = TintTypedArray.obtainStyledAttributes(this.mView.getContext(), attributeSet, C0667R.styleable.ViewBackgroundHelper, i, 0);
        try {
            if (attributeSet.hasValue(C0667R.styleable.ViewBackgroundHelper_android_background) != 0) {
                this.mBackgroundResId = attributeSet.getResourceId(C0667R.styleable.ViewBackgroundHelper_android_background, -1);
                i = this.mDrawableManager.getTintList(this.mView.getContext(), this.mBackgroundResId);
                if (i != 0) {
                    setInternalBackgroundTint(i);
                }
            }
            if (attributeSet.hasValue(C0667R.styleable.ViewBackgroundHelper_backgroundTint) != 0) {
                ViewCompat.m2179a(this.mView, attributeSet.getColorStateList(C0667R.styleable.ViewBackgroundHelper_backgroundTint));
            }
            if (attributeSet.hasValue(C0667R.styleable.ViewBackgroundHelper_backgroundTintMode) != 0) {
                ViewCompat.m2181a(this.mView, DrawableUtils.parseTintMode(attributeSet.getInt(C0667R.styleable.ViewBackgroundHelper_backgroundTintMode, -1), null));
            }
    ...
    private boolean applyFrameworkTintUsingColorFilter(@NonNull Drawable drawable) {
        ...
        tintInfo.clear();
        ColorStateList v = ViewCompat.m2230v(this.mView);
        if (v != null) {
            tintInfo.mHasTintList = true;
            tintInfo.mTintList = v;
        }
        Mode w = ViewCompat.m2231w(this.mView);
        if (w != null) {
