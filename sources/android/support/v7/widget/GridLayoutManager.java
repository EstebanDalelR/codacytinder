...
public class GridLayoutManager extends LinearLayoutManager {
    ...
    public void onInitializeAccessibilityNodeInfoForItem(Recycler recycler, State state, View view, C0586b c0586b) {
        ...
        if (layoutParams instanceof LayoutParams) {
            ...
            if (this.mOrientation == null) {
                ...
                c0586b.m2265b(C0585b.m2248a(state, spanSize, recycler, 1, z, false));
            } else {
                int spanIndex = layoutParams2.getSpanIndex();
                int spanSize2 = layoutParams2.getSpanSize();
                z = this.mSpanCount > 1 && layoutParams2.getSpanSize() == this.mSpanCount;
                c0586b.m2265b(C0585b.m2248a(recycler, 1, spanIndex, spanSize2, z, false));
            }
            return;
        }
        super.onInitializeAccessibilityNodeInfoForItem(view, c0586b);
    }
    ...
    private int getSpanGroupIndex(Recycler recycler, State state, int i) {
        ...
        state.append("Cannot find span size for pre layout position. ");
        state.append(i);
        Log.w(recycler, state.toString());
        return null;
    }
    ...
    private int getSpanIndex(Recycler recycler, State state, int i) {
        ...
        recycler = TAG;
        state = new StringBuilder();
        state.append("Cannot find span size for pre layout position. It is not cached, not in the adapter. Pos:");
        state.append(i);
        Log.w(recycler, state.toString());
        return null;
    }
    ...
    void layoutChunk(Recycler recycler, State state, LayoutState layoutState, LayoutChunkResult layoutChunkResult) {
        ...
        float f = 0.0f;
        int i6 = i4;
        assignSpans(recycler2, state2, i4, i3, z);
        int i7 = 0;
        for (i2 = 0; i2 < i6; i2++) {
            boolean z2;
            ...
            float decoratedMeasurementInOther = (((float) r6.mOrientationHelper.getDecoratedMeasurementInOther(view)) * 1.0f) / ((float) ((LayoutParams) view.getLayoutParams()).mSpanSize);
        ...
        while (spanSize < i6) {
            ...
            if (r6.mOrientation != 1) {
                decoratedMeasurement = getPaddingTop() + r6.mCachedBorders[layoutParams2.mSpanIndex];
                i5 = r6.mOrientationHelper.getDecoratedMeasurementInOther(view2) + decoratedMeasurement;
            } else if (isLayoutRTL()) {
                i2 = getPaddingLeft() + r6.mCachedBorders[r6.mSpanCount - layoutParams2.mSpanIndex];
                i9 = i2;
                decoratedMeasurementInOther2 = i2 - r6.mOrientationHelper.getDecoratedMeasurementInOther(view2);
                i = decoratedMeasurement;
                i10 = i5;
                layoutDecoratedWithMargins(view2, decoratedMeasurementInOther2, i, i9, i10);
                ...
                i7 = r6.mOrientationHelper.getDecoratedMeasurementInOther(view2) + i2;
            }
