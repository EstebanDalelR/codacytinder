...
import android.support.v4.widget.C2913j;
...
class DropDownListView extends ListView {
    ...
    private C0609n mClickAnimation;
    ...
    DropDownListView(Context context, boolean z) {
        super(context, null, C0667R.attr.dropDownListViewStyle);
        this.mHijackFocus = z;
        setCacheColorHint(0);
        try {
        ...
        if (i < 0) {
            ...
            if (!z) {
                if (this.mScrollHelper == 0) {
                    this.mScrollHelper = new C2913j(this);
                }
                this.mScrollHelper.m2542a(true);
                this.mScrollHelper.onTouch(this, motionEvent);
            } else if (this.mScrollHelper != null) {
                this.mScrollHelper.m2542a(false);
            }
            return z;
        }
