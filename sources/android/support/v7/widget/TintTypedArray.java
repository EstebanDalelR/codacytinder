...
import android.support.v4.content.res.C0441a.C0440a;
...
public class TintTypedArray {
    ...
    @Nullable
    public Typeface getFont(@StyleableRes int i, int i2, @Nullable C0440a c0440a) {
        i = this.mWrapped.getResourceId(i, 0);
        if (i == 0) {
            return 0;
        }
        ...
        return C0441a.m1666a(this.mContext, i, this.mTypedValue, i2, c0440a);
    }
