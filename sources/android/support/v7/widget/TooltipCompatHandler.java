...
class TooltipCompatHandler implements OnAttachStateChangeListener, OnHoverListener, OnLongClickListener {
    ...
    private final Runnable mHideRunnable = new C07382();
    private TooltipPopup mPopup;
    private final Runnable mShowRunnable = new C07371();
    ...
    private void show(boolean z) {
        if (ViewCompat.m2171C(this.mAnchor)) {
            long j;
            setPendingHandler(null);
            ...
            } else if (ViewCompat.m2225q(this.mAnchor) & true) {
