...
import android.support.v4.widget.C2906d;
...
public class SearchView extends LinearLayoutCompat implements CollapsibleActionView {
    ...
    class C07203 implements OnFocusChangeListener {
        C07203() {
        }
    ...
    class C07214 implements OnLayoutChangeListener {
        C07214() {
        }
    ...
    class C07225 implements OnClickListener {
        C07225() {
        }
    ...
    class C07236 implements OnKeyListener {
        C07236() {
        }
    ...
    class C07247 implements OnEditorActionListener {
        C07247() {
        }
    ...
    class C07258 implements OnItemClickListener {
        C07258() {
        }
    ...
    class C07269 implements OnItemSelectedListener {
...
*/
    ...
    static class SavedState extends AbsSavedState {
        public static final Creator<SavedState> CREATOR = new C07271();
        boolean isIconified;

        /* renamed from: android.support.v7.widget.SearchView$SavedState$1 */
        static class C07271 implements ClassLoaderCreator<SavedState> {
            C07271() {
            }
    ...
    public static class SearchAutoComplete extends AppCompatAutoCompleteTextView {
        ...
        public SearchAutoComplete(Context context, AttributeSet attributeSet) {
            this(context, attributeSet, C0667R.attr.autoCompleteTextViewStyle);
        }

        public SearchAutoComplete(Context context, AttributeSet attributeSet, int i) {
            super(context, attributeSet, i);
            this.mRunShowSoftInputIfNecessary = new C07281();
    ...
    public SearchView(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C0667R.attr.searchViewStyle);
    }
    ...
    public SearchView(Context context, AttributeSet attributeSet, int i) {
        ...
        this.mUpdateDrawableStateRunnable = new C07181();
        this.mReleaseCursorRunnable = new C07192();
        this.mOutsideDrawablesCache = new WeakHashMap();
        this.mOnClickListener = new C07225();
        this.mTextKeyListener = new C07236();
        this.mOnEditorActionListener = new C07247();
        this.mOnItemClickListener = new C07258();
        this.mOnItemSelectedListener = new C07269();
        ...
        attributeSet = TintTypedArray.obtainStyledAttributes(context, attributeSet, C0667R.styleable.SearchView, i, 0);
        LayoutInflater.from(context).inflate(attributeSet.getResourceId(C0667R.styleable.SearchView_layout, C0667R.layout.abc_search_view), this, true);
        this.mSearchSrcTextView = (SearchAutoComplete) findViewById(C0667R.id.search_src_text);
        this.mSearchSrcTextView.setSearchView(this);
        this.mSearchEditFrame = findViewById(C0667R.id.search_edit_frame);
        this.mSearchPlate = findViewById(C0667R.id.search_plate);
        this.mSubmitArea = findViewById(C0667R.id.submit_area);
        this.mSearchButton = (ImageView) findViewById(C0667R.id.search_button);
        this.mGoButton = (ImageView) findViewById(C0667R.id.search_go_btn);
        this.mCloseButton = (ImageView) findViewById(C0667R.id.search_close_btn);
        this.mVoiceButton = (ImageView) findViewById(C0667R.id.search_voice_btn);
        this.mCollapsedIcon = (ImageView) findViewById(C0667R.id.search_mag_icon);
        ViewCompat.m2183a(this.mSearchPlate, attributeSet.getDrawable(C0667R.styleable.SearchView_queryBackground));
        ViewCompat.m2183a(this.mSubmitArea, attributeSet.getDrawable(C0667R.styleable.SearchView_submitBackground));
        this.mSearchButton.setImageDrawable(attributeSet.getDrawable(C0667R.styleable.SearchView_searchIcon));
        this.mGoButton.setImageDrawable(attributeSet.getDrawable(C0667R.styleable.SearchView_goIcon));
        this.mCloseButton.setImageDrawable(attributeSet.getDrawable(C0667R.styleable.SearchView_closeIcon));
        this.mVoiceButton.setImageDrawable(attributeSet.getDrawable(C0667R.styleable.SearchView_voiceIcon));
        this.mCollapsedIcon.setImageDrawable(attributeSet.getDrawable(C0667R.styleable.SearchView_searchIcon));
        this.mSearchHintIcon = attributeSet.getDrawable(C0667R.styleable.SearchView_searchHintIcon);
        TooltipCompat.setTooltipText(this.mSearchButton, getResources().getString(C0667R.string.abc_searchview_description_search));
        this.mSuggestionRowLayout = attributeSet.getResourceId(C0667R.styleable.SearchView_suggestionRowLayout, C0667R.layout.abc_search_dropdown_item_icons_2line);
        this.mSuggestionCommitIconResId = attributeSet.getResourceId(C0667R.styleable.SearchView_commitIcon, 0);
        ...
        this.mSearchSrcTextView.setOnFocusChangeListener(new C07203());
        setIconifiedByDefault(attributeSet.getBoolean(C0667R.styleable.SearchView_iconifiedByDefault, true));
        context = attributeSet.getDimensionPixelSize(C0667R.styleable.SearchView_android_maxWidth, -1);
        if (context != -1) {
            setMaxWidth(context);
        }
        this.mDefaultQueryHint = attributeSet.getText(C0667R.styleable.SearchView_defaultQueryHint);
        this.mQueryHint = attributeSet.getText(C0667R.styleable.SearchView_queryHint);
        context = attributeSet.getInt(C0667R.styleable.SearchView_android_imeOptions, -1);
        if (context != -1) {
            setImeOptions(context);
        }
        context = attributeSet.getInt(C0667R.styleable.SearchView_android_inputType, -1);
        if (context != -1) {
            setInputType(context);
        }
        setFocusable(attributeSet.getBoolean(C0667R.styleable.SearchView_android_focusable, true));
        ...
        if (this.mDropDownAnchor != null) {
            this.mDropDownAnchor.addOnLayoutChangeListener(new C07214());
        }
    ...
    public void setSuggestionsAdapter(C2906d c2906d) {
        this.mSuggestionsAdapter = c2906d;
        this.mSearchSrcTextView.setAdapter(this.mSuggestionsAdapter);
    }

    public C2906d getSuggestionsAdapter() {
    ...
    private int getPreferredWidth() {
        return getContext().getResources().getDimensionPixelSize(C0667R.dimen.abc_search_view_preferred_width);
    }

    private int getPreferredHeight() {
        return getContext().getResources().getDimensionPixelSize(C0667R.dimen.abc_search_view_preferred_height);
    }
...
*/
    ...
    void adjustDropDownSizeAndPosition() {
        if (this.mDropDownAnchor.getWidth() > 1) {
            ...
            int dimensionPixelSize = this.mIconifiedByDefault ? resources.getDimensionPixelSize(C0667R.dimen.abc_dropdownitem_icon_width) + resources.getDimensionPixelSize(C0667R.dimen.abc_dropdownitem_text_padding_left) : 0;
