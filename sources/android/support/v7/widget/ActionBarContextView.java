...
public class ActionBarContextView extends AbsActionBarView {
    ...
    public /* bridge */ /* synthetic */ C0609n setupAnimatorToVisibility(int i, long j) {
    ...
    public ActionBarContextView(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C0667R.attr.actionModeStyle);
    }

    public ActionBarContextView(Context context, AttributeSet attributeSet, int i) {
        super(context, attributeSet, i);
        context = TintTypedArray.obtainStyledAttributes(context, attributeSet, C0667R.styleable.ActionMode, i, 0);
        ViewCompat.m2183a((View) this, context.getDrawable(C0667R.styleable.ActionMode_background));
        this.mTitleStyleRes = context.getResourceId(C0667R.styleable.ActionMode_titleTextStyle, 0);
        this.mSubtitleStyleRes = context.getResourceId(C0667R.styleable.ActionMode_subtitleTextStyle, 0);
        this.mContentHeight = context.getLayoutDimension(C0667R.styleable.ActionMode_height, 0);
        this.mCloseItemLayout = context.getResourceId(C0667R.styleable.ActionMode_closeItemLayout, C0667R.layout.abc_action_mode_close_item_material);
        context.recycle();
    }
    ...
    private void initTitle() {
        if (this.mTitleLayout == null) {
            LayoutInflater.from(getContext()).inflate(C0667R.layout.abc_action_bar_title_item, this);
            this.mTitleLayout = (LinearLayout) getChildAt(getChildCount() - 1);
            this.mTitleView = (TextView) this.mTitleLayout.findViewById(C0667R.id.action_bar_title);
            this.mSubtitleView = (TextView) this.mTitleLayout.findViewById(C0667R.id.action_bar_subtitle);
    ...
    public void initForMode(final ActionMode actionMode) {
        ...
        this.mClose.findViewById(C0667R.id.action_mode_close_button).setOnClickListener(new OnClickListener() {
        ...
        ViewCompat.m2183a(this.mMenuView, null);
