...
import android.support.v4.view.accessibility.C0586b.C0584a;
import android.support.v4.view.accessibility.C0586b.C0585b;
import android.support.v4.widget.C0641g;
...
public class RecyclerView extends ViewGroup implements NestedScrollingChild2, ScrollingView {
    ...
    static final Interpolator sQuinticInterpolator = new C07153();
    ...
    private C0598g mScrollingChildHelper;
    final State mState;
    ...
    static class C07153 implements Interpolator {
    ...
    public static abstract class Adapter<VH extends ViewHolder> {
        ...
        public final VH createViewHolder(@NonNull ViewGroup viewGroup, int i) {
            try {
                C0529b.m1953a(RecyclerView.TRACE_CREATE_VIEW_TAG);
        ...
        public final void bindViewHolder(@NonNull VH vh, int i) {
            ...
            vh.setFlags(1, 519);
            C0529b.m1953a(RecyclerView.TRACE_BIND_VIEW_TAG);
    ...
    public static abstract class LayoutManager {
        ...
        private final Callback mHorizontalBoundCheckCallback = new C29521();
        ...
        private final Callback mVerticalBoundCheckCallback = new C29532();
        private int mWidth;
        ...
        class C29521 implements Callback {
            C29521() {
            }
        ...
        class C29532 implements Callback {
            C29532() {
            }
        ...
        public void postOnAnimation(Runnable runnable) {
            if (this.mRecyclerView != null) {
                ViewCompat.m2188a(this.mRecyclerView, runnable);
            }
        }
        ...
        public int getLayoutDirection() {
            return ViewCompat.m2208f(this.mRecyclerView);
        }
        ...
        public int getPaddingStart() {
            return this.mRecyclerView != null ? ViewCompat.m2210g(this.mRecyclerView) : 0;
        }

        public int getPaddingEnd() {
            return this.mRecyclerView != null ? ViewCompat.m2212h(this.mRecyclerView) : 0;
        }
        ...
        public void ignoreView(View view) {
            if (view.getParent() == this.mRecyclerView) {
                if (this.mRecyclerView.indexOfChild(view) != -1) {
                    ...
                    view.addFlags(ProfileEditingConfig.DEFAULT_MAX_LENGTH);
        ...
        public int getMinimumWidth() {
            return ViewCompat.m2218k(this.mRecyclerView);
        }

        public int getMinimumHeight() {
            return ViewCompat.m2220l(this.mRecyclerView);
        }
        ...
        void onInitializeAccessibilityNodeInfo(C0586b c0586b) {
            onInitializeAccessibilityNodeInfo(this.mRecyclerView.mRecycler, this.mRecyclerView.mState, c0586b);
        }

        public void onInitializeAccessibilityNodeInfo(Recycler recycler, State state, C0586b c0586b) {
            ...
            c0586b.m2259a(C0584a.m2247a(getRowCountForAccessibility(recycler, state), getColumnCountForAccessibility(recycler, state), isLayoutHierarchical(recycler, state), getSelectionModeForAccessibility(recycler, state)));
        }
        ...
        void onInitializeAccessibilityNodeInfoForItem(View view, C0586b c0586b) {
            ViewHolder childViewHolderInt = RecyclerView.getChildViewHolderInt(view);
            if (childViewHolderInt != null && !childViewHolderInt.isRemoved() && !this.mChildHelper.isHidden(childViewHolderInt.itemView)) {
                onInitializeAccessibilityNodeInfoForItem(this.mRecyclerView.mRecycler, this.mRecyclerView.mState, view, c0586b);
            }
        }

        public void onInitializeAccessibilityNodeInfoForItem(Recycler recycler, State state, View view, C0586b c0586b) {
            c0586b.m2265b(C0585b.m2248a(canScrollVertically() != null ? getPosition(view) : 0, 1, canScrollHorizontally() != null ? getPosition(view) : 0, 1, false, false));
        }
        ...
        public static Properties getProperties(Context context, AttributeSet attributeSet, int i, int i2) {
            ...
            context = context.obtainStyledAttributes(attributeSet, C0670R.styleable.RecyclerView, i, i2);
            properties.orientation = context.getInt(C0670R.styleable.RecyclerView_android_orientation, 1);
            properties.spanCount = context.getInt(C0670R.styleable.RecyclerView_spanCount, 1);
            properties.reverseLayout = context.getBoolean(C0670R.styleable.RecyclerView_reverseLayout, false);
            properties.stackFromEnd = context.getBoolean(C0670R.styleable.RecyclerView_stackFromEnd, false);
            context.recycle();
            return properties;
        }
    ...
    public final class Recycler {
        ...
        private void attachAccessibilityDelegateOnBind(ViewHolder viewHolder) {
            if (RecyclerView.this.isAccessibilityEnabled()) {
                ...
                if (!ViewCompat.m2192a(view)) {
                    viewHolder.addFlags(16384);
                    ViewCompat.m2185a(view, RecyclerView.this.mAccessibilityDelegate.getItemDelegate());
                }
            }
        }
        ...
        void addViewHolderToRecycledViewPool(ViewHolder viewHolder, boolean z) {
            ...
            if (viewHolder.hasAnyOfTheFlags(16384)) {
                ...
                ViewCompat.m2185a(viewHolder.itemView, null);
            }
            if (z) {
    ...
    class ViewFlinger implements Runnable {
        ...
        public void run() {
            ...
            if (overScroller.computeScrollOffset()) {
                ...
                if (RecyclerView.this.mAdapter != null) {
                    ...
                    C0529b.m1953a(RecyclerView.TRACE_SCROLL_TAG);
        ...
        void postOnAnimation() {
            ...
            ViewCompat.m2188a(RecyclerView.this, (Runnable) this);
        }
    ...
    public static abstract class ViewHolder {
        ...
        private void onEnteredHiddenState(RecyclerView recyclerView) {
            if (this.mPendingAccessibilityState != -1) {
                ...
                this.mWasImportantForAccessibilityBeforeHidden = ViewCompat.m2203d(this.itemView);
            }
        ...
        public final boolean isRecyclable() {
            return (this.mFlags & 16) == 0 && !ViewCompat.m2199b(this.itemView);
        }
    ...
    class C29494 implements ProcessCallback {
        C29494() {
        }
    ...
    class C29505 implements Callback {
        C29505() {
        }
    ...
    class C29516 implements Callback {
        C29516() {
        }
    ...
    private class RecyclerViewDataObserver extends AdapterDataObserver {
        ...
        void triggerUpdateProcessor() {
            if (RecyclerView.POST_UPDATES_ON_ANIMATION && RecyclerView.this.mHasFixedSize && RecyclerView.this.mIsAttached) {
                ViewCompat.m2188a(RecyclerView.this, RecyclerView.this.mUpdateChildViewsRunnable);
                return;
            }
    ...
    public static class SavedState extends AbsSavedState {
        public static final Creator<SavedState> CREATOR = new C07161();
        Parcelable mLayoutState;

        /* renamed from: android.support.v7.widget.RecyclerView$SavedState$1 */
        static class C07161 implements ClassLoaderCreator<SavedState> {
            C07161() {
            }
    ...
    public RecyclerView(Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        this.mUpdateChildViewsRunnable = new C07131();
        ...
        this.mItemAnimatorRunner = new C07142();
        this.mViewInfoProcessCallback = new C29494();
        ...
        this.mScaledHorizontalScrollFactor = C0602k.m2352a(viewConfiguration, context);
        this.mScaledVerticalScrollFactor = C0602k.m2354b(viewConfiguration, context);
        ...
        if (attributeSet != null) {
            obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0670R.styleable.RecyclerView, i, 0);
            String string = obtainStyledAttributes.getString(C0670R.styleable.RecyclerView_layoutManager);
            if (obtainStyledAttributes.getInt(C0670R.styleable.RecyclerView_android_descendantFocusability, -1) == -1) {
                setDescendantFocusability(262144);
            }
            this.mEnableFastScroller = obtainStyledAttributes.getBoolean(C0670R.styleable.RecyclerView_fastScrollEnabled, false);
            if (this.mEnableFastScroller) {
                initFastScroller((StateListDrawable) obtainStyledAttributes.getDrawable(C0670R.styleable.RecyclerView_fastScrollVerticalThumbDrawable), obtainStyledAttributes.getDrawable(C0670R.styleable.RecyclerView_fastScrollVerticalTrackDrawable), (StateListDrawable) obtainStyledAttributes.getDrawable(C0670R.styleable.RecyclerView_fastScrollHorizontalThumbDrawable), obtainStyledAttributes.getDrawable(C0670R.styleable.RecyclerView_fastScrollHorizontalTrackDrawable));
            }
            obtainStyledAttributes.recycle();
    ...
    public void setAccessibilityDelegateCompat(RecyclerViewAccessibilityDelegate recyclerViewAccessibilityDelegate) {
        ...
        ViewCompat.m2185a((View) this, this.mAccessibilityDelegate);
    }
    ...
    private void initChildrenHelper() {
        this.mChildHelper = new ChildHelper(new C29505());
    }

    void initAdapterManager() {
        this.mAdapterHelper = new AdapterHelper(new C29516());
    }
            ...
            if (!this.mDataSetHasChangedAfterLayout) {
                if (this.mAdapterHelper.hasPendingUpdates()) {
                    if (this.mAdapterHelper.hasAnyUpdateTypes(4) && !this.mAdapterHelper.hasAnyUpdateTypes(11)) {
                        C0529b.m1953a(TRACE_HANDLE_ADAPTER_UPDATES_TAG);
                        startInterceptRequestLayout();
                        ...
                        C0529b.m1953a(TRACE_ON_DATA_SET_CHANGE_LAYOUT_TAG);
                        dispatchLayout();
                        C0529b.m1952a();
                    }
                    return;
    ...
    boolean scrollByInternal(int i, int i2, MotionEvent motionEvent) {
        ...
        if (this.mAdapter != null) {
            startInterceptRequestLayout();
            onEnterLayoutOrScroll();
            C0529b.m1953a(TRACE_SCROLL_TAG);
        ...
        if (dispatchNestedScroll(scrollHorizontallyBy, scrollVerticallyBy, i3, i4, this.mScrollOffset, 0)) {
            ...
            if (!(motionEvent == null || C0597f.m2328d(motionEvent, 8194))) {
    ...
    private void pullGlows(float f, float f2, float f3, float f4) {
        ...
        if (f2 < 0.0f) {
            ensureLeftGlow();
            C0641g.m2576a(this.mLeftGlow, (-f2) / ((float) getWidth()), 1.0f - (f3 / ((float) getHeight())));
        } else if (f2 > 0.0f) {
            ensureRightGlow();
            C0641g.m2576a(this.mRightGlow, f2 / ((float) getWidth()), f3 / ((float) getHeight()));
        } else {
            f3 = 0.0f;
            if (f4 < 0.0f) {
                ensureTopGlow();
                C0641g.m2576a(this.mTopGlow, (-f4) / ((float) getHeight()), f / ((float) getWidth()));
            } else if (f4 <= 0.0f) {
                ensureBottomGlow();
                C0641g.m2576a(this.mBottomGlow, f4 / ((float) getHeight()), 1.0f - (f / ((float) getWidth())));
            } else {
                obj = f3;
            }
    ...
    public void setEdgeEffectFactory(@NonNull EdgeEffectFactory edgeEffectFactory) {
        C0561l.m2061a(edgeEffectFactory);
    ...
    protected void onAttachedToWindow() {
        ...
        if (ALLOW_THREAD_GAP_WORK) {
            ...
            if (this.mGapWorker == null) {
                ...
                Display E = ViewCompat.m2173E(this);
    ...
    void defaultOnMeasure(int i, int i2) {
        setMeasuredDimension(LayoutManager.chooseSize(i, getPaddingLeft() + getPaddingRight(), ViewCompat.m2218k(this)), LayoutManager.chooseSize(i2, getPaddingTop() + getPaddingBottom(), ViewCompat.m2220l(this)));
    }
    ...
    boolean shouldDeferAccessibilityEvent(AccessibilityEvent accessibilityEvent) {
        ...
        accessibilityEvent = accessibilityEvent != null ? C0583a.m2245a(accessibilityEvent) : null;
        if (accessibilityEvent == null) {
    ...
    void postAnimationRunner() {
        if (!this.mPostedAnimatorRunner && this.mIsAttached) {
            ViewCompat.m2188a((View) this, this.mItemAnimatorRunner);
    ...
    protected void onLayout(boolean z, int i, int i2, int i3, int i4) {
        C0529b.m1953a(TRACE_ON_LAYOUT_TAG);
        dispatchLayout();
        C0529b.m1952a();
    ...
    boolean setChildImportantForAccessibilityInternal(ViewHolder viewHolder, int i) {
        ...
        ViewCompat.m2176a(viewHolder.itemView, i);
        return true;
    }
    ...
    void initFastScroller(StateListDrawable stateListDrawable, Drawable drawable, StateListDrawable stateListDrawable2, Drawable drawable2) {
        if (!(stateListDrawable == null || drawable == null || stateListDrawable2 == null)) {
            if (drawable2 != null) {
                ...
                FastScroller fastScroller = new FastScroller(this, stateListDrawable, drawable, stateListDrawable2, drawable2, resources.getDimensionPixelSize(C0670R.dimen.fastscroll_default_thickness), resources.getDimensionPixelSize(C0670R.dimen.fastscroll_minimum_range), resources.getDimensionPixelOffset(C0670R.dimen.fastscroll_margin));
                return;
            }
        }
    ...
    public void setNestedScrollingEnabled(boolean z) {
        getScrollingChildHelper().m2331a(z);
    }

    public boolean isNestedScrollingEnabled() {
        return getScrollingChildHelper().m2332a();
    }

    public boolean startNestedScroll(int i) {
        return getScrollingChildHelper().m2342b(i);
    }

    public boolean startNestedScroll(int i, int i2) {
        return getScrollingChildHelper().m2336a(i, i2);
    }

    public void stopNestedScroll() {
        getScrollingChildHelper().m2343c();
    }

    public void stopNestedScroll(int i) {
        getScrollingChildHelper().m2344c(i);
    }

    public boolean hasNestedScrollingParent() {
        return getScrollingChildHelper().m2341b();
    }

    public boolean hasNestedScrollingParent(int i) {
        return getScrollingChildHelper().m2335a(i);
    }

    public boolean dispatchNestedScroll(int i, int i2, int i3, int i4, int[] iArr) {
        return getScrollingChildHelper().m2337a(i, i2, i3, i4, iArr);
    }

    public boolean dispatchNestedScroll(int i, int i2, int i3, int i4, int[] iArr, int i5) {
        return getScrollingChildHelper().m2338a(i, i2, i3, i4, iArr, i5);
    }

    public boolean dispatchNestedPreScroll(int i, int i2, int[] iArr, int[] iArr2) {
        return getScrollingChildHelper().m2339a(i, i2, iArr, iArr2);
    }

    public boolean dispatchNestedPreScroll(int i, int i2, int[] iArr, int[] iArr2, int i3) {
        return getScrollingChildHelper().m2340a(i, i2, iArr, iArr2, i3);
    }

    public boolean dispatchNestedFling(float f, float f2, boolean z) {
        return getScrollingChildHelper().m2334a(f, f2, z);
    }

    public boolean dispatchNestedPreFling(float f, float f2) {
        return getScrollingChildHelper().m2333a(f, f2);
    }
    ...
    private C0598g getScrollingChildHelper() {
        if (this.mScrollingChildHelper == null) {
            this.mScrollingChildHelper = new C0598g(this);
        }
