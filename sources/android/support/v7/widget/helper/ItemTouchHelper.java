...
public class ItemTouchHelper extends ItemDecoration implements OnChildAttachStateChangeListener {
    ...
    float mDx;
    float mDy;
    C0592b mGestureDetector;
    float mInitialTouchX;
    float mInitialTouchY;
    private ItemTouchHelperGestureListener mItemTouchHelperGestureListener;
    float mMaxSwipeVelocity;
    private final OnItemTouchListener mOnItemTouchListener = new C29562();
    View mOverdrawChild = null;
    int mOverdrawChildPosition = -1;
    final List<View> mPendingCleanup = new ArrayList();
    List<RecoverAnimation> mRecoverAnimations = new ArrayList();
    RecyclerView mRecyclerView;
    final Runnable mScrollRunnable = new C07391();
    ...
    class C07391 implements Runnable {
        ...
        public void run() {
            if (ItemTouchHelper.this.mSelected != null && ItemTouchHelper.this.scrollIfNecessary()) {
                ...
                ViewCompat.m2188a(ItemTouchHelper.this.mRecyclerView, (Runnable) this);
            }
        }
    }
    ...
    public static abstract class Callback {
        ...
        private static final Interpolator sDragScrollInterpolator = new C07411();
        private static final Interpolator sDragViewScrollCapInterpolator = new C07422();
        private static final ItemTouchUIUtil sUICallback;
        private int mCachedMaxScrollSpeed = -1;

        /* renamed from: android.support.v7.widget.helper.ItemTouchHelper$Callback$1 */
        static class C07411 implements Interpolator {
        ...
        static class C07422 implements Interpolator {
            public float getInterpolation(float f) {
                f -= 1.0f;
        ...
        final int getAbsoluteMovementFlags(RecyclerView recyclerView, ViewHolder viewHolder) {
            return convertToAbsoluteDirection(getMovementFlags(recyclerView, viewHolder), ViewCompat.m2208f(recyclerView));
        }
        ...
        private int getMaxDragScroll(RecyclerView recyclerView) {
            if (this.mCachedMaxScrollSpeed == -1) {
                this.mCachedMaxScrollSpeed = recyclerView.getResources().getDimensionPixelSize(C0670R.dimen.item_touch_helper_max_drag_scroll_per_frame);
            }
    ...
    private static class RecoverAnimation implements AnimatorListener {
        ...
        class C07431 implements AnimatorUpdateListener {
            C07431() {
            }
    ...
    class C29562 implements OnItemTouchListener {
        C29562() {
        }

        public boolean onInterceptTouchEvent(RecyclerView recyclerView, MotionEvent motionEvent) {
            ItemTouchHelper.this.mGestureDetector.m2312a(motionEvent);
    ...
    class C29585 implements ChildDrawingOrderCallback {
        C29585() {
        }
    ...
    public void attachToRecyclerView(@Nullable RecyclerView recyclerView) {
        if (this.mRecyclerView != recyclerView) {
            ...
            if (recyclerView != null) {
                ...
                this.mSwipeEscapeVelocity = recyclerView.getDimension(C0670R.dimen.item_touch_helper_swipe_escape_velocity);
                this.mMaxSwipeVelocity = recyclerView.getDimension(C0670R.dimen.item_touch_helper_swipe_escape_max_velocity);
                setupCallbacks();
            }
        }
    }
    ...
    private void startGestureDetection() {
        ...
        this.mGestureDetector = new C0592b(this.mRecyclerView.getContext(), this.mItemTouchHelperGestureListener);
    }
        ...
        if (viewHolder2 != this.mSelected || i2 != r11.mActionState) {
            ...
            if (r11.mSelected != null) {
                ...
                if (viewHolder3.itemView.getParent() != null) {
                    ...
                    RecoverAnimation c29573 = new RecoverAnimation(viewHolder3, i6, i3, f2, f3, f, signum) {
                        public void onAnimationEnd(Animator animator) {
    ...
    private int swipeIfNecessary(ViewHolder viewHolder) {
        ...
        int convertToAbsoluteDirection = (this.mCallback.convertToAbsoluteDirection(movementFlags, ViewCompat.m2208f(this.mRecyclerView)) & ACTION_MODE_SWIPE_MASK) >> 8;
        ...
        if (Math.abs(this.mDx) > Math.abs(this.mDy)) {
            ...
            if (checkHorizontalSwipe > 0) {
                return (movementFlags & checkHorizontalSwipe) == null ? Callback.convertToRelativeDirection(checkHorizontalSwipe, ViewCompat.m2208f(this.mRecyclerView)) : checkHorizontalSwipe;
            } else {
        ...
        if (viewHolder > null) {
            return (movementFlags & viewHolder) == 0 ? Callback.convertToRelativeDirection(viewHolder, ViewCompat.m2208f(this.mRecyclerView)) : viewHolder;
        }
        return 0;
    }
    ...
    private void addChildDrawingOrderCallback() {
        if (VERSION.SDK_INT < 21) {
            if (this.mChildDrawingOrderCallback == null) {
                this.mChildDrawingOrderCallback = new C29585();
            }
