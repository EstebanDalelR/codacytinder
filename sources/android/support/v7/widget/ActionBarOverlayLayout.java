...
public class ActionBarOverlayLayout extends ViewGroup implements NestedScrollingParent, DecorContentParent {
    static final int[] ATTRS = new int[]{C0667R.attr.actionBarSize, 16842841};
    ...
    private final C0599h mParentHelper;
    ...
    class C06851 extends AnimatorListenerAdapter {
        C06851() {
        }
    ...
    public ActionBarOverlayLayout(Context context, AttributeSet attributeSet) {
        ...
        this.mTopAnimatorListener = new C06851();
        this.mRemoveActionBarHideOffset = new C06862();
        this.mAddActionBarHideOffset = new C06873();
        init(context);
        this.mParentHelper = new C0599h(this);
    }
    ...
    protected boolean fitSystemWindows(Rect rect) {
        pullChildren();
        int q = ViewCompat.m2225q(this) & 256;
    ...
    protected void onMeasure(int i, int i2) {
        ...
        Object obj = (ViewCompat.m2225q(this) & 256) != 0 ? 1 : null;
        if (obj != null) {
    ...
    public void onNestedScrollAccepted(View view, View view2, int i) {
        this.mParentHelper.m2348a(view, view2, i);
    ...
    public int getNestedScrollAxes() {
        return this.mParentHelper.m2345a();
    }

    void pullChildren() {
        if (this.mContent == null) {
            this.mContent = (ContentFrameLayout) findViewById(C0667R.id.action_bar_activity_content);
            this.mActionBarTop = (ActionBarContainer) findViewById(C0667R.id.action_bar_container);
            this.mDecorToolbar = getDecorToolbar(findViewById(C0667R.id.action_bar));
        }
    }
