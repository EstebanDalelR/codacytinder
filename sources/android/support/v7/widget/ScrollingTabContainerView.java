...
public class ScrollingTabContainerView extends HorizontalScrollView implements OnItemSelectedListener {
    ...
    private class TabView extends LinearLayout {
        ...
        public TabView(Context context, Tab tab, boolean z) {
            super(context, null, C0667R.attr.actionBarTabStyle);
            this.mTab = tab;
            ScrollingTabContainerView obtainStyledAttributes = TintTypedArray.obtainStyledAttributes(context, null, this.BG_ATTRS, C0667R.attr.actionBarTabStyle, 0);
        ...
        public void update() {
            ...
            if (isEmpty != 0) {
                if (this.mTextView == null) {
                    View appCompatTextView = new AppCompatTextView(getContext(), null, C0667R.attr.actionBarTabTextStyle);
    ...
    private LinearLayoutCompat createTabLayout() {
        LinearLayoutCompat linearLayoutCompat = new LinearLayoutCompat(getContext(), null, C0667R.attr.actionBarTabBarStyle);
    ...
    private Spinner createSpinner() {
        Spinner appCompatSpinner = new AppCompatSpinner(getContext(), null, C0667R.attr.actionDropDownStyle);
