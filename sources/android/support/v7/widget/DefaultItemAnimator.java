    ...
    public void runPendingAnimations() {
        ...
        if (isEmpty != 0 || isEmpty2 != 0 || isEmpty4 != 0 || isEmpty3 != 0) {
            ...
            if (isEmpty2 != 0) {
                ...
                if (isEmpty != 0) {
                    ViewCompat.m2189a(((MoveInfo) arrayList.get(0)).holder.itemView, c06961, getRemoveDuration());
                } else {
                    c06961.run();
                }
            }
            if (isEmpty3 != 0) {
                ...
                if (isEmpty != 0) {
                    ViewCompat.m2189a(((ChangeInfo) arrayList.get(0)).oldHolder.itemView, c06961, getRemoveDuration());
                } else {
                    c06961.run();
                }
            }
            if (isEmpty4 != 0) {
                ...
                ViewCompat.m2189a(((ViewHolder) arrayList2.get(0)).itemView, c06983, removeDuration + Math.max(moveDuration, j));
            }
        }
    }
