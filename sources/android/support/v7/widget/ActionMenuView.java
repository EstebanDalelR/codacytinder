...
public class ActionMenuView extends LinearLayoutCompat implements ItemInvoker, MenuView {
    ...
    private void onMeasureExactFormat(int i, int i2) {
        ...
        while (i14 > 0 && i10 > 0) {
            paddingTop = 0;
            int i16 = 0;
            int i17 = ActivityChooserViewAdapter.MAX_ACTIVITY_COUNT_UNLIMITED;
            long j3 = 0;
            while (paddingTop < i3) {
            ...
            while (size < i3) {
                ...
                if ((j3 & j4) != 0) {
                    boolean z3;
                    if (obj4 == null || !layoutParams3.preventEdgeOffset) {
                        z3 = true;
                    } else {
                        z3 = true;
                        if (i10 == 1) {
        ...
        if (obj3 == null) {
            ...
            if (i12 == 1) {
                obj4 = 1;
                if (i10 > 0 || j == 0 || (i10 >= i12 - r2 && obj4 == null && i13 <= r2)) {
                    size = i7;
                    size2 = 0;
                    obj2 = obj;
                } else {
                    ...
                    i16 = bitCount > 0.0f ? (int) (((float) (i10 * i9)) / bitCount) : 0;
                    obj2 = obj;
                    size = i7;
                    for (childMeasureSpec = 0; childMeasureSpec < size; childMeasureSpec++) {
                        if ((j & ((long) (1 << childMeasureSpec))) != 0) {
                            ...
                            if (childAt4 instanceof ActionMenuItemView) {
                                ...
                                layoutParams5.extraPixels = i16;
                                layoutParams5.expanded = true;
                                layoutParams5.rightMargin = (-i16) / 2;
                            } else {
