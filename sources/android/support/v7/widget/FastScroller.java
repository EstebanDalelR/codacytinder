...
class FastScroller extends ItemDecoration implements OnItemTouchListener {
    ...
    private final Runnable mHideRunnable = new C07051();
    @VisibleForTesting
    ...
    private final OnScrollListener mOnScrollListener = new C29352();
    ...
    class C29352 extends OnScrollListener {
        C29352() {
        }
    ...
    private boolean isLayoutRTL() {
        return ViewCompat.m2208f(this.mRecyclerView) == 1;
    }
