...
import android.support.v4.widget.C0643i;
...
public class AppCompatImageHelper {
    ...
    public void loadFromAttributes(AttributeSet attributeSet, int i) {
        attributeSet = TintTypedArray.obtainStyledAttributes(this.mView.getContext(), attributeSet, C0667R.styleable.AppCompatImageView, i, 0);
        try {
            i = this.mView.getDrawable();
            if (i == 0) {
                int resourceId = attributeSet.getResourceId(C0667R.styleable.AppCompatImageView_srcCompat, -1);
                if (resourceId != -1) {
            ...
            if (attributeSet.hasValue(C0667R.styleable.AppCompatImageView_tint) != 0) {
                C0643i.m2582a(this.mView, attributeSet.getColorStateList(C0667R.styleable.AppCompatImageView_tint));
            }
            if (attributeSet.hasValue(C0667R.styleable.AppCompatImageView_tintMode) != 0) {
                C0643i.m2583a(this.mView, DrawableUtils.parseTintMode(attributeSet.getInt(C0667R.styleable.AppCompatImageView_tintMode, -1), null));
            }
    ...
    private boolean applyFrameworkTintUsingColorFilter(@NonNull Drawable drawable) {
        ...
        tintInfo.clear();
        ColorStateList a = C0643i.m2581a(this.mView);
        if (a != null) {
            tintInfo.mHasTintList = true;
            tintInfo.mTintList = a;
        }
        Mode b = C0643i.m2584b(this.mView);
        if (b != null) {
