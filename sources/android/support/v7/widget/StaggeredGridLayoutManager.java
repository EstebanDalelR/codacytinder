...
public class StaggeredGridLayoutManager extends LayoutManager implements ScrollVectorProvider {
    ...
    private final Runnable mCheckForGapsRunnable = new C07291();
    ...
    static class LazySpanLookup {
        ...
        static class FullSpanItem implements Parcelable {
            public static final Creator<FullSpanItem> CREATOR = new C07301();
            int mGapDir;
            int[] mGapPerSpan;
            ...
            static class C07301 implements Creator<FullSpanItem> {
                C07301() {
                }
    ...
    public static class SavedState implements Parcelable {
        public static final Creator<SavedState> CREATOR = new C07311();
        ...
        static class C07311 implements Creator<SavedState> {
            C07311() {
            }
    ...
    public void onInitializeAccessibilityNodeInfoForItem(Recycler recycler, State state, View view, C0586b c0586b) {
        ...
        if (this.mOrientation == null) {
            c0586b.m2265b(C0585b.m2248a(layoutParams.getSpanIndex(), layoutParams.mFullSpan != null ? this.mSpanCount : 1, -1, -1, layoutParams.mFullSpan, false));
        } else {
            c0586b.m2265b(C0585b.m2248a(-1, -1, layoutParams.getSpanIndex(), layoutParams.mFullSpan != null ? this.mSpanCount : 1, layoutParams.mFullSpan, false));
        }
    }
