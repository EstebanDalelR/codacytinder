...
public class Toolbar extends ViewGroup {
    ...
    class C29551 implements android.support.v7.widget.ActionMenuView.OnMenuItemClickListener {
        C29551() {
        }
        ...
        public boolean expandItemActionView(MenuBuilder menuBuilder, MenuItemImpl menuItemImpl) {
            ...
            if (menuBuilder != Toolbar.this) {
                if (menuBuilder instanceof ViewGroup) {
                    ((ViewGroup) menuBuilder).removeView(Toolbar.this.mCollapseButtonView);
                }
            ...
            if (menuBuilder != Toolbar.this) {
                if (menuBuilder instanceof ViewGroup) {
                    ((ViewGroup) menuBuilder).removeView(Toolbar.this.mExpandedActionView);
                }
    ...
    public static class SavedState extends AbsSavedState {
        public static final Creator<SavedState> CREATOR = new C07351();
        int expandedMenuItemId;
        boolean isOverflowOpen;

        /* renamed from: android.support.v7.widget.Toolbar$SavedState$1 */
        static class C07351 implements ClassLoaderCreator<SavedState> {
            C07351() {
            }
    ...
    public Toolbar(Context context, @Nullable AttributeSet attributeSet) {
        this(context, attributeSet, C0667R.attr.toolbarStyle);
    }
    ...
    public Toolbar(Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        this.mMenuViewItemClickListener = new C29551();
        this.mShowOverflowMenuRunnable = new C07332();
        context = TintTypedArray.obtainStyledAttributes(getContext(), attributeSet, C0667R.styleable.Toolbar, i, 0);
        this.mTitleTextAppearance = context.getResourceId(C0667R.styleable.Toolbar_titleTextAppearance, 0);
        this.mSubtitleTextAppearance = context.getResourceId(C0667R.styleable.Toolbar_subtitleTextAppearance, 0);
        this.mGravity = context.getInteger(C0667R.styleable.Toolbar_android_gravity, this.mGravity);
        this.mButtonGravity = context.getInteger(C0667R.styleable.Toolbar_buttonGravity, 48);
        attributeSet = context.getDimensionPixelOffset(C0667R.styleable.Toolbar_titleMargin, 0);
        if (context.hasValue(C0667R.styleable.Toolbar_titleMargins) != 0) {
            attributeSet = context.getDimensionPixelOffset(C0667R.styleable.Toolbar_titleMargins, attributeSet);
        }
        ...
        attributeSet = context.getDimensionPixelOffset(C0667R.styleable.Toolbar_titleMarginStart, -1);
        if (attributeSet >= null) {
            this.mTitleMarginStart = attributeSet;
        }
        attributeSet = context.getDimensionPixelOffset(C0667R.styleable.Toolbar_titleMarginEnd, -1);
        if (attributeSet >= null) {
            this.mTitleMarginEnd = attributeSet;
        }
        attributeSet = context.getDimensionPixelOffset(C0667R.styleable.Toolbar_titleMarginTop, -1);
        if (attributeSet >= null) {
            this.mTitleMarginTop = attributeSet;
        }
        attributeSet = context.getDimensionPixelOffset(C0667R.styleable.Toolbar_titleMarginBottom, -1);
        if (attributeSet >= null) {
            this.mTitleMarginBottom = attributeSet;
        }
        this.mMaxButtonHeight = context.getDimensionPixelSize(C0667R.styleable.Toolbar_maxButtonHeight, -1);
        attributeSet = context.getDimensionPixelOffset(C0667R.styleable.Toolbar_contentInsetStart, Integer.MIN_VALUE);
        int dimensionPixelOffset = context.getDimensionPixelOffset(C0667R.styleable.Toolbar_contentInsetEnd, Integer.MIN_VALUE);
        int dimensionPixelSize = context.getDimensionPixelSize(C0667R.styleable.Toolbar_contentInsetLeft, 0);
        int dimensionPixelSize2 = context.getDimensionPixelSize(C0667R.styleable.Toolbar_contentInsetRight, 0);
        ensureContentInsets();
        ...
        this.mContentInsetStartWithNavigation = context.getDimensionPixelOffset(C0667R.styleable.Toolbar_contentInsetStartWithNavigation, Integer.MIN_VALUE);
        this.mContentInsetEndWithActions = context.getDimensionPixelOffset(C0667R.styleable.Toolbar_contentInsetEndWithActions, Integer.MIN_VALUE);
        this.mCollapseIcon = context.getDrawable(C0667R.styleable.Toolbar_collapseIcon);
        this.mCollapseDescription = context.getText(C0667R.styleable.Toolbar_collapseContentDescription);
        CharSequence text = context.getText(C0667R.styleable.Toolbar_title);
        if (!TextUtils.isEmpty(text)) {
            setTitle(text);
        }
        text = context.getText(C0667R.styleable.Toolbar_subtitle);
        if (!TextUtils.isEmpty(text)) {
            setSubtitle(text);
        }
        this.mPopupContext = getContext();
        setPopupTheme(context.getResourceId(C0667R.styleable.Toolbar_popupTheme, 0));
        Drawable drawable = context.getDrawable(C0667R.styleable.Toolbar_navigationIcon);
        if (drawable != null) {
            setNavigationIcon(drawable);
        }
        text = context.getText(C0667R.styleable.Toolbar_navigationContentDescription);
        if (!TextUtils.isEmpty(text)) {
            setNavigationContentDescription(text);
        }
        drawable = context.getDrawable(C0667R.styleable.Toolbar_logo);
        if (drawable != null) {
            setLogo(drawable);
        }
        text = context.getText(C0667R.styleable.Toolbar_logoDescription);
        if (!TextUtils.isEmpty(text)) {
            setLogoDescription(text);
        }
        if (context.hasValue(C0667R.styleable.Toolbar_titleTextColor) != null) {
            setTitleTextColor(context.getColor(C0667R.styleable.Toolbar_titleTextColor, -1));
        }
        if (context.hasValue(C0667R.styleable.Toolbar_subtitleTextColor) != null) {
            setSubtitleTextColor(context.getColor(C0667R.styleable.Toolbar_subtitleTextColor, -1));
        }
        context.recycle();
    }
    ...
    private void ensureNavButtonView() {
        if (this.mNavButtonView == null) {
            this.mNavButtonView = new AppCompatImageButton(getContext(), null, C0667R.attr.toolbarNavigationButtonStyle);
            android.view.ViewGroup.LayoutParams generateDefaultLayoutParams = generateDefaultLayoutParams();
    ...
    void ensureCollapseButtonView() {
        if (this.mCollapseButtonView == null) {
            this.mCollapseButtonView = new AppCompatImageButton(getContext(), null, C0667R.attr.toolbarNavigationButtonStyle);
            ...
            this.mCollapseButtonView.setOnClickListener(new C07343());
        }
    }
    ...
    protected void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        Object obj2 = ViewCompat.m2208f(this) == 1 ? 1 : null;
        int width = getWidth();
        ...
        l = l >= 0 ? Math.min(l, i4 - i2) : 0;
        if (!shouldLayout(toolbar.mNavButtonView)) {
            i5 = paddingLeft;
        } else if (obj2 != null) {
            layoutChildRight = layoutChildRight(toolbar.mNavButtonView, i13, iArr, l);
            i5 = paddingLeft;
            if (shouldLayout(toolbar.mCollapseButtonView)) {
                if (obj2 == null) {
                    layoutChildRight = layoutChildRight(toolbar.mCollapseButtonView, layoutChildRight, iArr, l);
                } else {
                    i5 = layoutChildLeft(toolbar.mCollapseButtonView, i5, iArr, l);
                }
            }
            if (shouldLayout(toolbar.mMenuView)) {
                if (obj2 == null) {
                    i5 = layoutChildLeft(toolbar.mMenuView, i5, iArr, l);
                } else {
                    layoutChildRight = layoutChildRight(toolbar.mMenuView, layoutChildRight, iArr, l);
                }
            }
            ...
            if (shouldLayout(toolbar.mExpandedActionView)) {
                if (obj2 == null) {
                    i13 = layoutChildRight(toolbar.mExpandedActionView, i13, iArr, l);
                } else {
                    max = layoutChildLeft(toolbar.mExpandedActionView, max, iArr, l);
                }
            }
            if (shouldLayout(toolbar.mLogoView)) {
                if (obj2 == null) {
                    i13 = layoutChildRight(toolbar.mLogoView, i13, iArr, l);
                } else {
                    max = layoutChildLeft(toolbar.mLogoView, max, iArr, l);
                }
            }
            ...
            if (!shouldLayout) {
                if (shouldLayout2) {
                    ...
                    size = toolbar.mTempViews.size();
                    for (max = 0; max < size; max++) {
                        i13 = layoutChildRight((View) toolbar.mTempViews.get(max), i13, iArr, l);
                    }
...
*/
                    ...
                    private void addCustomViewsWithGravity(List<View> list, int i) {
                        Object obj = ViewCompat.m2208f(this) == 1 ? 1 : null;
                        int childCount = getChildCount();
                        i = C0593c.m2313a(i, ViewCompat.m2208f(this));
                        list.clear();
                        View childAt;
                        if (obj != null) {
                    ...
                    private int getHorizontalMargins(View view) {
                        MarginLayoutParams marginLayoutParams = (MarginLayoutParams) view.getLayoutParams();
                        return C0596e.m2318a(marginLayoutParams) + C0596e.m2320b(marginLayoutParams);
                    }
