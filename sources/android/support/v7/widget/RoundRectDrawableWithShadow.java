...
class RoundRectDrawableWithShadow extends Drawable {
    ...
    RoundRectDrawableWithShadow(Resources resources, ColorStateList colorStateList, float f, float f2, float f3) {
        this.mShadowStartColor = resources.getColor(C0668R.color.cardview_shadow_start_color);
        this.mShadowEndColor = resources.getColor(C0668R.color.cardview_shadow_end_color);
        this.mInsetShadow = resources.getDimensionPixelSize(C0668R.dimen.cardview_compat_inset_shadow);
    ...
    private void setShadowSize(float f, float f2) {
        ...
        if (f < 0.0f) {
            ...
            if (this.mRawShadowSize != f || this.mRawMaxShadowSize != f2) {
                ...
                this.mShadowSize = (float) ((int) (((f * 1.5f) + ((float) this.mInsetShadow)) + 0.5f));
                this.mDirty = true;
                invalidateSelf();
            }
        }
