...
public class SwitchCompat extends CompoundButton {
    ...
    public SwitchCompat(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C0667R.attr.switchStyle);
    }
    ...
    public SwitchCompat(Context context, AttributeSet attributeSet, int i) {
        ...
        attributeSet = TintTypedArray.obtainStyledAttributes(context, attributeSet, C0667R.styleable.SwitchCompat, i, 0);
        this.mThumbDrawable = attributeSet.getDrawable(C0667R.styleable.SwitchCompat_android_thumb);
        if (this.mThumbDrawable != 0) {
            this.mThumbDrawable.setCallback(this);
        }
        this.mTrackDrawable = attributeSet.getDrawable(C0667R.styleable.SwitchCompat_track);
        if (this.mTrackDrawable != 0) {
            this.mTrackDrawable.setCallback(this);
        }
        this.mTextOn = attributeSet.getText(C0667R.styleable.SwitchCompat_android_textOn);
        this.mTextOff = attributeSet.getText(C0667R.styleable.SwitchCompat_android_textOff);
        this.mShowText = attributeSet.getBoolean(C0667R.styleable.SwitchCompat_showText, true);
        this.mThumbTextPadding = attributeSet.getDimensionPixelSize(C0667R.styleable.SwitchCompat_thumbTextPadding, 0);
        this.mSwitchMinWidth = attributeSet.getDimensionPixelSize(C0667R.styleable.SwitchCompat_switchMinWidth, 0);
        this.mSwitchPadding = attributeSet.getDimensionPixelSize(C0667R.styleable.SwitchCompat_switchPadding, 0);
        this.mSplitTrack = attributeSet.getBoolean(C0667R.styleable.SwitchCompat_splitTrack, false);
        i = attributeSet.getColorStateList(C0667R.styleable.SwitchCompat_thumbTint);
        if (i != 0) {
            this.mThumbTintList = i;
            this.mHasThumbTint = true;
        }
        i = DrawableUtils.parseTintMode(attributeSet.getInt(C0667R.styleable.SwitchCompat_thumbTintMode, -1), null);
        ...
        i = attributeSet.getColorStateList(C0667R.styleable.SwitchCompat_trackTint);
        if (i != 0) {
            this.mTrackTintList = i;
            this.mHasTrackTint = true;
        }
        i = DrawableUtils.parseTintMode(attributeSet.getInt(C0667R.styleable.SwitchCompat_trackTintMode, -1), null);
        ...
        i = attributeSet.getResourceId(C0667R.styleable.SwitchCompat_switchTextAppearance, 0);
        if (i != 0) {
    ...
    public void setSwitchTextAppearance(Context context, int i) {
        context = TintTypedArray.obtainStyledAttributes(context, i, C0667R.styleable.TextAppearance);
        i = context.getColorStateList(C0667R.styleable.TextAppearance_android_textColor);
        if (i != 0) {
            this.mTextColors = i;
        } else {
            this.mTextColors = getTextColors();
        }
        i = context.getDimensionPixelSize(C0667R.styleable.TextAppearance_android_textSize, 0);
        if (i != 0) {
            i = (float) i;
        ...
        setSwitchTypefaceByIndex(context.getInt(C0667R.styleable.TextAppearance_android_typeface, -1), context.getInt(C0667R.styleable.TextAppearance_android_textStyle, -1));
        if (context.getBoolean(C0667R.styleable.TextAppearance_textAllCaps, false) != 0) {
    ...
    private void applyTrackTint() {
        ...
        if (this.mHasTrackTint || this.mHasTrackTintMode) {
            ...
            if (this.mHasTrackTint) {
                C0450a.m1719a(this.mTrackDrawable, this.mTrackTintList);
            }
            if (this.mHasTrackTintMode) {
                C0450a.m1722a(this.mTrackDrawable, this.mTrackTintMode);
            }
    ...
    private void applyThumbTint() {
        ...
        if (this.mHasThumbTint || this.mHasThumbTintMode) {
            ...
            if (this.mHasThumbTint) {
                C0450a.m1719a(this.mThumbDrawable, this.mThumbTintList);
            }
            if (this.mHasThumbTintMode) {
                C0450a.m1722a(this.mThumbDrawable, this.mThumbTintMode);
            }
    ...
    public void draw(Canvas canvas) {
        ...
        if (this.mThumbDrawable != null) {
            ...
            if (background != null) {
                C0450a.m1718a(background, i, i2, thumbOffset, i4);
            }
        }
        super.draw(canvas);
    }
    ...
    public void drawableHotspotChanged(float f, float f2) {
        ...
        if (this.mThumbDrawable != null) {
            C0450a.m1716a(this.mThumbDrawable, f, f2);
        }
        if (this.mTrackDrawable != null) {
            C0450a.m1716a(this.mTrackDrawable, f, f2);
        }
    }
