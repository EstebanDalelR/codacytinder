...
import android.support.v7.gridlayout.C0669R;
...
public class GridLayout extends ViewGroup {
    private static final int ALIGNMENT_MODE = C0669R.styleable.GridLayout_alignmentMode;
    public static final int ALIGN_BOUNDS = 0;
    public static final int ALIGN_MARGINS = 1;
    public static final Alignment BASELINE = new C29427();
    public static final Alignment BOTTOM = TRAILING;
    static final int CAN_STRETCH = 2;
    public static final Alignment CENTER = new C29406();
    private static final int COLUMN_COUNT = C0669R.styleable.GridLayout_columnCount;
    private static final int COLUMN_ORDER_PRESERVED = C0669R.styleable.GridLayout_columnOrderPreserved;
    ...
    public static final Alignment FILL = new C29438();
    public static final int HORIZONTAL = 0;
    static final int INFLEXIBLE = 0;
    private static final Alignment LEADING = new C29373();
    ...
    static final Printer NO_PRINTER = new C07071();
    private static final int ORIENTATION = C0669R.styleable.GridLayout_orientation;
    public static final Alignment RIGHT = createSwitchingAlignment(END, START);
    private static final int ROW_COUNT = C0669R.styleable.GridLayout_rowCount;
    private static final int ROW_ORDER_PRESERVED = C0669R.styleable.GridLayout_rowOrderPreserved;
    public static final Alignment START = LEADING;
    public static final Alignment TOP = LEADING;
    private static final Alignment TRAILING = new C29384();
    public static final int UNDEFINED = Integer.MIN_VALUE;
    static final Alignment UNDEFINED_ALIGNMENT = new C29362();
    static final int UNINITIALIZED_HASH = 0;
    private static final int USE_DEFAULT_MARGINS = C0669R.styleable.GridLayout_useDefaultMargins;
    ...
    static class C07071 implements Printer {
    ...
    static class Bounds {
        ...
        protected int getOffset(GridLayout gridLayout, View view, Alignment alignment, int i, boolean z) {
            return this.before - alignment.getAlignmentValue(view, i, C0604l.m2358a(gridLayout));
        }

        protected final void include(GridLayout gridLayout, View view, Spec spec, Axis axis, int i) {
            this.flexibility &= spec.getFlexibility();
            gridLayout = spec.getAbsoluteAlignment(axis.horizontal).getAlignmentValue(view, i, C0604l.m2358a(gridLayout));
    ...
    public static class LayoutParams extends MarginLayoutParams {
        private static final int BOTTOM_MARGIN = C0669R.styleable.GridLayout_Layout_android_layout_marginBottom;
        private static final int COLUMN = C0669R.styleable.GridLayout_Layout_layout_column;
        private static final int COLUMN_SPAN = C0669R.styleable.GridLayout_Layout_layout_columnSpan;
        private static final int COLUMN_WEIGHT = C0669R.styleable.GridLayout_Layout_layout_columnWeight;
        ...
        private static final int GRAVITY = C0669R.styleable.GridLayout_Layout_layout_gravity;
        private static final int LEFT_MARGIN = C0669R.styleable.GridLayout_Layout_android_layout_marginLeft;
        private static final int MARGIN = C0669R.styleable.GridLayout_Layout_android_layout_margin;
        private static final int RIGHT_MARGIN = C0669R.styleable.GridLayout_Layout_android_layout_marginRight;
        private static final int ROW = C0669R.styleable.GridLayout_Layout_layout_row;
        private static final int ROW_SPAN = C0669R.styleable.GridLayout_Layout_layout_rowSpan;
        private static final int ROW_WEIGHT = C0669R.styleable.GridLayout_Layout_layout_rowWeight;
        private static final int TOP_MARGIN = C0669R.styleable.GridLayout_Layout_android_layout_marginTop;
        ...
        private void reInitSuper(Context context, AttributeSet attributeSet) {
            context = context.obtainStyledAttributes(attributeSet, C0669R.styleable.GridLayout_Layout);
            try {
        ...
        private void init(Context context, AttributeSet attributeSet) {
            ...
            try {
                ...
                this.columnSpec = GridLayout.spec(context.getInt(COLUMN, Integer.MIN_VALUE), context.getInt(COLUMN_SPAN, DEFAULT_SPAN_SIZE), GridLayout.getAlignment(attributeSet, GridLayout.DEFAULT_ORDER_PRESERVED), context.getFloat(COLUMN_WEIGHT, 0.0f));
                this.rowSpec = GridLayout.spec(context.getInt(ROW, Integer.MIN_VALUE), context.getInt(ROW_SPAN, DEFAULT_SPAN_SIZE), GridLayout.getAlignment(attributeSet, false), context.getFloat(ROW_WEIGHT, 0.0f));
            } finally {
                context.recycle();
            }
        }
    ...
    static class C29362 extends Alignment {
    ...
    static class C29373 extends Alignment {
        public int getAlignmentValue(View view, int i, int i2) {
            return 0;
        }
    ...
    static class C29384 extends Alignment {
        public int getAlignmentValue(View view, int i, int i2) {
            return i;
        }
    ...
    static class C29406 extends Alignment {
        public int getAlignmentValue(View view, int i, int i2) {
            return i >> 1;
        }
    ...
    static class C29427 extends Alignment {

        /* renamed from: android.support.v7.widget.GridLayout$7$1 */
        class C29411 extends Bounds {
            private int size;
    ...
    static class C29438 extends Alignment {
        public int getAlignmentValue(View view, int i, int i2) {
            return Integer.MIN_VALUE;
        }
    ...
    public GridLayout(Context context, AttributeSet attributeSet, int i) {
        ...
        this.mDefaultGap = context.getResources().getDimensionPixelOffset(C0669R.dimen.default_gap);
        context = context.obtainStyledAttributes(attributeSet, C0669R.styleable.GridLayout);
        try {
    ...
    private boolean isLayoutRtlCompat() {
        return ViewCompat.m2208f(this) == 1 ? DEFAULT_ORDER_PRESERVED : false;
    }
