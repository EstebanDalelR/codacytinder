...
public class MenuItemWrapperICS extends BaseMenuWrapper<SupportMenuItem> implements MenuItem {
    ...
    public MenuItem setActionView(int i) {
        ...
        i = ((SupportMenuItem) this.mWrappedObject).getActionView();
        if (i instanceof android.view.CollapsibleActionView) {
            ((SupportMenuItem) this.mWrappedObject).setActionView(new CollapsibleActionViewWrapper(i));
        }
        return this;
    }
    ...
    public void setExclusiveCheckable(boolean z) {
        try {
            ...
            Log.w(LOG_TAG, "Error while calling setExclusiveCheckable", z2);
        }
    }
