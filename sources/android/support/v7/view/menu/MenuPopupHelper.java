...
public class MenuPopupHelper implements MenuHelper {
    ...
    class C06801 implements OnDismissListener {
        C06801() {
        }
    ...
    public MenuPopupHelper(@NonNull Context context, @NonNull MenuBuilder menuBuilder) {
        this(context, menuBuilder, null, false, C0667R.attr.popupMenuStyle, 0);
    }

    public MenuPopupHelper(@NonNull Context context, @NonNull MenuBuilder menuBuilder, @NonNull View view) {
        this(context, menuBuilder, view, false, C0667R.attr.popupMenuStyle, 0);
    }
    ...
    public MenuPopupHelper(@NonNull Context context, @NonNull MenuBuilder menuBuilder, @NonNull View view, boolean z, @AttrRes int i, @StyleRes int i2) {
        ...
        this.mInternalOnDismissListener = new C06801();
    ...
    private MenuPopup createPopup() {
        ...
        if ((Math.min(point.x, point.y) >= this.mContext.getResources().getDimensionPixelSize(C0667R.dimen.abc_cascading_menus_min_smallest_width) ? 1 : null) != null) {
    ...
    private void showPopup(int i, int i2, boolean z, boolean z2) {
        ...
        if (z) {
            if (C0593c.m2313a(this.mDropDownGravity, ViewCompat.m2208f(this.mAnchorView)) & 7) {
