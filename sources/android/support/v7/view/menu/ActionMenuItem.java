...
public class ActionMenuItem implements SupportMenuItem {
    ...
    public MenuItem setIcon(int i) {
        this.mIconResId = i;
        this.mIconDrawable = C0432b.m1640a(this.mContext, i);
        applyIconTint();
        return this;
    }
    ...
    private void applyIconTint() {
        ...
        if (this.mHasIconTint || this.mHasIconTintMode) {
            this.mIconDrawable = C0450a.m1730g(this.mIconDrawable);
            this.mIconDrawable = this.mIconDrawable.mutate();
            if (this.mHasIconTint) {
                C0450a.m1719a(this.mIconDrawable, this.mIconTintList);
            }
            if (this.mHasIconTintMode) {
                C0450a.m1722a(this.mIconDrawable, this.mIconTintMode);
            }
        }
    }
}
