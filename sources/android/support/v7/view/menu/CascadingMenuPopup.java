...
final class CascadingMenuPopup extends MenuPopup implements MenuPresenter, OnKeyListener, OnDismissListener {
    ...
    private final OnAttachStateChangeListener mAttachStateChangeListener = new C06782();
    private final Context mContext;
    private int mDropDownGravity = 0;
    private boolean mForceShowIcon;
    private final OnGlobalLayoutListener mGlobalLayoutListener = new C06771();
    private boolean mHasXOffset;
    private boolean mHasYOffset;
    private int mLastPosition;
    private final MenuItemHoverListener mMenuItemHoverListener = new C29263();
    ...
    class C06771 implements OnGlobalLayoutListener {
        C06771() {
        }
    ...
    class C06782 implements OnAttachStateChangeListener {
    ...
    class C29263 implements MenuItemHoverListener {
        C29263() {
        }
    ...
    public CascadingMenuPopup(@NonNull Context context, @NonNull View view, @AttrRes int i, @StyleRes int i2, boolean z) {
        ...
        this.mMenuMaxWidth = Math.max(context.getDisplayMetrics().widthPixels / 2, context.getDimensionPixelSize(C0667R.dimen.abc_config_prefDialogWidth));
    ...
    private int getInitialMenuPosition() {
        return ViewCompat.m2208f(this.mAnchorView) == 1 ? 0 : 1;
    }
    ...
    private void showMenu(@NonNull MenuBuilder menuBuilder) {
        ...
        if (cascadingMenuInfo == null && this.mShowTitle && menuBuilder.getHeaderTitle() != null) {
            FrameLayout frameLayout = (FrameLayout) from.inflate(C0667R.layout.abc_popup_menu_header_item_layout, listView, false);
    ...
    public void setGravity(int i) {
        if (this.mRawDropDownGravity != i) {
            ...
            this.mDropDownGravity = C0593c.m2313a(i, ViewCompat.m2208f(this.mAnchorView));
        }
    }
    ...
    public void setAnchorView(@NonNull View view) {
        if (this.mAnchorView != view) {
            this.mAnchorView = view;
            this.mDropDownGravity = C0593c.m2313a(this.mRawDropDownGravity, ViewCompat.m2208f(this.mAnchorView));
        }
    }
