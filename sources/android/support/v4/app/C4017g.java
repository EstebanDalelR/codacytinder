...
public class C4017g extends Fragment implements OnCancelListener, OnDismissListener {
    ...
    public void show(FragmentManager fragmentManager, String str) {
        ...
        fragmentManager = fragmentManager.mo429a();
        fragmentManager.mo405a((Fragment) this, str);
        fragmentManager.mo410c();
    }

    public int show(C0405n c0405n, String str) {
        this.mDismissed = false;
        this.mShownByMe = true;
        c0405n.mo405a((Fragment) this, str);
        this.mViewDestroyed = false;
        this.mBackStackId = c0405n.mo410c();
    ...
    void dismissInternal(boolean z) {
        if (!this.mDismissed) {
            ...
            if (this.mBackStackId >= 0) {
                getFragmentManager().mo430a(this.mBackStackId, 1);
                this.mBackStackId = true;
            } else {
                C0405n a = getFragmentManager().mo429a();
                a.mo404a((Fragment) this);
                if (z) {
                    a.mo412d();
                } else {
                    a.mo410c();
    ...
    public LayoutInflater onGetLayoutInflater(Bundle bundle) {
        ...
        if (this.mDialog == null) {
            return (LayoutInflater) this.mHost.m11070i().getSystemService("layout_inflater");
        }
