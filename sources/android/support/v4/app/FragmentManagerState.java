...
final class FragmentManagerState implements Parcelable {
    public static final Creator<FragmentManagerState> CREATOR = new C03731();
    ...
    static class C03731 implements Creator<FragmentManagerState> {
        C03731() {
        }

        public /* synthetic */ Object createFromParcel(Parcel parcel) {
            return m1365a(parcel);
        }
        ...
        /* renamed from: a */
        public FragmentManagerState m1365a(Parcel parcel) {
            return new FragmentManagerState(parcel);
        }

        /* renamed from: a */
        public FragmentManagerState[] m1366a(int i) {
