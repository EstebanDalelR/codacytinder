...
public class C0447c {
    ...
    /* renamed from: android.support.v4.graphics.c$a */
    ...
    /* renamed from: android.support.v4.graphics.c$b */
    public static class C0446b {
        ...
        C0446b(char c, float[] fArr) {
            this.f1488a = c;
            this.f1489b = fArr;
        }

        C0446b(C0446b c0446b) {
            this.f1488a = c0446b.f1488a;
            this.f1489b = C0447c.m1702a(c0446b.f1489b, 0, c0446b.f1489b.length);
        }

        /* renamed from: a */
        public static void m1695a(C0446b[] c0446bArr, Path path) {
            float[] fArr = new float[6];
            char c = 'm';
            for (int i = 0; i < c0446bArr.length; i++) {
                C0446b.m1694a(path, fArr, c, c0446bArr[i].f1488a, c0446bArr[i].f1489b);
                c = c0446bArr[i].f1488a;
            }
        }

        /* renamed from: a */
        public void m1696a(C0446b c0446b, C0446b c0446b2, float f) {
            for (int i = 0; i < c0446b.f1489b.length; i++) {
                this.f1489b[i] = (c0446b.f1489b[i] * (1.0f - f)) + (c0446b2.f1489b[i] * f);
            }
        }
        ...
        /* renamed from: a */
        private static void m1694a(android.graphics.Path r27, float[] r28, char r29, char r30, float[] r31) {
            /*
            r10 = r27;
            r13 = r31;
            r14 = 0;
        ...
        L_0x0182:
            ...
            r26 = r9;
            r9 = r25;
            android.support.v4.graphics.C0447c.C0446b.m1693a(r0, r1, r2, r3, r4, r5, r6, r7, r8, r9);
            r0 = r13[r14];
            r8 = r11 + r0;
            r0 = r13[r15];
            r7 = r12 + r0;
        ...
        L_0x02dc:
            ...
            return;
            */
            throw new UnsupportedOperationException("Method not decompiled: android.support.v4.graphics.c.b.a(android.graphics.Path, float[], char, char, float[]):void");
        }

        /* renamed from: a */
        private static void m1693a(Path path, float f, float f2, float f3, float f4, float f5, float f6, float f7, boolean z, boolean z2) {
            float f8 = f;
            float f9 = f3;
            float f10 = f5;
            float f11 = f6;
            ...
            if (cos < 0.0d) {
                ...
                C0446b.m1693a(path, f, f2, f9, f4, f10 * f8, f11 * f8, f7, z, z2);
                return;
            }
            boolean z4 = z2;
            ...
            d11 *= d9;
            d12 *= toRadians;
            C0446b.m1692a(path, (d11 * d14) - (d12 * d13), (d11 * d13) + (d12 * d14), d9, toRadians, d3, d5, d2, sqrt, atan2);
        }

        /* renamed from: a */
        private static void m1692a(Path path, double d, double d2, double d3, double d4, double d5, double d6, double d7, double d8, double d9) {
            double d10 = d3;
    ...
    /* renamed from: a */
    static float[] m1702a(float[] fArr, int i, int i2) {
        if (i > i2) {
    ...
    /* renamed from: a */
    public static Path m1698a(String str) {
        Path path = new Path();
        C0446b[] b = C0447c.m1705b(str);
        if (b == null) {
            return null;
        }
        try {
            C0446b.m1695a(b, path);
            return path;
        } catch (Throwable e) {
            StringBuilder stringBuilder = new StringBuilder();
    ...
    /* renamed from: b */
    public static C0446b[] m1705b(String str) {
        if (str == null) {
            return null;
        }
        ...
        int i2 = 0;
        while (i < str.length()) {
            i = C0447c.m1697a(str, i);
            String trim = str.substring(i2, i).trim();
            if (trim.length() > 0) {
                C0447c.m1700a(arrayList, trim.charAt(0), C0447c.m1706c(trim));
            }
            i2 = i;
            i++;
        }
        if (i - i2 == 1 && i2 < str.length()) {
            C0447c.m1700a(arrayList, str.charAt(i2), new float[0]);
        }
        return (C0446b[]) arrayList.toArray(new C0446b[arrayList.size()]);
    }

    /* renamed from: a */
    public static C0446b[] m1703a(C0446b[] c0446bArr) {
        if (c0446bArr == null) {
            return null;
        }
        C0446b[] c0446bArr2 = new C0446b[c0446bArr.length];
        for (int i = 0; i < c0446bArr.length; i++) {
            c0446bArr2[i] = new C0446b(c0446bArr[i]);
        }
        return c0446bArr2;
    }

    /* renamed from: a */
    public static boolean m1701a(C0446b[] c0446bArr, C0446b[] c0446bArr2) {
        if (c0446bArr != null) {
            if (c0446bArr2 != null) {
                if (c0446bArr.length != c0446bArr2.length) {
                    return false;
                }
                int i = 0;
                while (i < c0446bArr.length) {
                    if (c0446bArr[i].f1488a == c0446bArr2[i].f1488a) {
                        if (c0446bArr[i].f1489b.length == c0446bArr2[i].f1489b.length) {
                            i++;
                        }
                    }
                    return false;
    ...
    /* renamed from: b */
    public static void m1704b(C0446b[] c0446bArr, C0446b[] c0446bArr2) {
        for (int i = 0; i < c0446bArr2.length; i++) {
            c0446bArr[i].f1488a = c0446bArr2[i].f1488a;
            for (int i2 = 0; i2 < c0446bArr2[i].f1489b.length; i2++) {
                c0446bArr[i].f1489b[i2] = c0446bArr2[i].f1489b[i2];
            }
        }
    }

    /* renamed from: a */
    private static int m1697a(String str, int i) {
        while (i < str.length()) {
    ...
    /* renamed from: a */
    private static void m1700a(ArrayList<C0446b> arrayList, char c, float[] fArr) {
        arrayList.add(new C0446b(c, fArr));
    }

    /* renamed from: c */
    private static float[] m1706c(String str) {
        if (str.charAt(0) != 'z') {
            if (str.charAt(0) != 'Z') {
                try {
                    ...
                    int i2 = 0;
                    while (i < length) {
                        C0447c.m1699a(str, i, c0445a);
                        int i3 = c0445a.f1486a;
                        if (i < i3) {
                            int i4 = i2 + 1;
                            fArr[i2] = Float.parseFloat(str.substring(i, i3));
                            i2 = i4;
                        }
                        i = c0445a.f1487b ? i3 : i3 + 1;
                    }
                    return C0447c.m1702a(fArr, 0, i2);
                } catch (Throwable e) {
                    StringBuilder stringBuilder = new StringBuilder();
                    stringBuilder.append("error in parsing \"");
                    stringBuilder.append(str);
    ...
    /* Code decompiled incorrectly, please refer to instructions dump. */
    /* renamed from: a */
    private static void m1699a(java.lang.String r8, int r9, android.support.v4.graphics.C0447c.C0445a r10) {
        /*
        r0 = 0;
        r10.f1487b = r0;
        r1 = r9;
    ...
    L_0x003d:
        ...
        return;
        */
        throw new UnsupportedOperationException("Method not decompiled: android.support.v4.graphics.c.a(java.lang.String, int, android.support.v4.graphics.c$a):void");
    }
}
