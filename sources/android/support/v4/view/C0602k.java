...
*/
    ...
    L_0x0006:
        ...
        f1804a = r0;	 Catch:{ Exception -> 0x0014 }
        goto L_0x001b;
    L_0x0014:
        r0 = "ViewConfigCompat";
    ...
    L_0x001b:
        return;
        */
        throw new UnsupportedOperationException("Method not decompiled: android.support.v4.view.k.<clinit>():void");
    }

    @Deprecated
    /* renamed from: a */
    public static int m2353a(ViewConfiguration viewConfiguration) {
        return viewConfiguration.getScaledPagingTouchSlop();
    }

    /* renamed from: a */
    public static float m2352a(@NonNull ViewConfiguration viewConfiguration, @NonNull Context context) {
        if (VERSION.SDK_INT >= 26) {
            return viewConfiguration.getScaledHorizontalScrollFactor();
        }
        return C0602k.m2355c(viewConfiguration, context);
    }

    /* renamed from: b */
    public static float m2354b(@NonNull ViewConfiguration viewConfiguration, @NonNull Context context) {
        if (VERSION.SDK_INT >= 26) {
    ...
    /* renamed from: c */
    private static float m2355c(android.view.ViewConfiguration r3, android.content.Context r4) {
        /* JADX: method processing error */
/*
Error: java.lang.NullPointerException
	at jadx.core.dex.visitors.regions.ProcessTryCatchRegions.searchTryCatchDominators(ProcessTryCatchRegions.java:75)
...
*/
    ...
    L_0x000a:
        r0 = f1804a;	 Catch:{ Exception -> 0x001b }
    ...
    L_0x0042:
        ...
        return r3;
        */
        throw new UnsupportedOperationException("Method not decompiled: android.support.v4.view.k.c(android.view.ViewConfiguration, android.content.Context):float");
    }
}
