...
final class ServiceMethod<R, T> {
    ...
    private final Converter<C15968t, R> responseConverter;
    ...
    static final class Builder<T, R> {
        ...
        Converter<C15968t, T> responseConverter;
        Type responseType;
        ...
        public ServiceMethod build() {
            ...
            if (this.responseType != Response.class) {
                if (this.responseType != C15966s.class) {
                    int i;
        ...
        private void parseMethodAnnotation(Annotation annotation) {
            if (annotation instanceof DELETE) {
                ...
                annotation = ((Headers) annotation).value();
        ...
        private C15957l parseHeaders(String[] strArr) {
                ...
                if (!(indexOf == -1 || indexOf == 0)) {
                    if (indexOf != str.length() - 1) {
                        ...
                        if (ManagerWebServices.PARAM_CONTENT_TYPE.equalsIgnoreCase(substring)) {
                            C15958m a = C15958m.a(str);
                            if (a == null) {
                                throw methodError("Malformed content type: %s", str);
                            }
                            this.contentType = a;
                        } else {
                            c15956a.a(substring, str);
                        }
                        i++;
                    }
                }
            ...
            if (annotation instanceof Url) {
                ...
                if (this.isMultipart) {
                    ...
                    if (!r0.isEmpty()) {
                        ...
                        annotation = C15957l.a(strArr);
                        if (Iterable.class.isAssignableFrom(r3)) {
                            if (type instanceof ParameterizedType) {
                                type = Utils.getParameterUpperBound(0, (ParameterizedType) type);
                                if (!C15960b.class.isAssignableFrom(Utils.getRawType(type))) {
                        ...
                        if ((type instanceof ParameterizedType) == null) {
                            ...
                            type.append("<String>)");
                            throw parameterError(i, type.toString(), new Object[0]);
                        } else if (C15960b.class.isAssignableFrom(Utils.getRawType(Utils.getParameterUpperBound(0, (ParameterizedType) type))) != null) {
                        ...
                        if (C15960b.class.isAssignableFrom(r3.getComponentType()) != null) {
                            return RawPart.INSTANCE.array();
                        }
                        throw parameterError(i, "@Part annotation must supply a name or use MultipartBody.Part parameter type.", new Object[0]);
                    } else if (C15960b.class.isAssignableFrom(r3) != null) {
        ...
        private Converter<C15968t, T> createResponseConverter() {
            try {
    ...
    C15963q toRequest(@Nullable Object... objArr) throws IOException {
    ...
    R toResponse(C15968t c15968t) throws IOException {
        return this.responseConverter.convert(c15968t);
    }
