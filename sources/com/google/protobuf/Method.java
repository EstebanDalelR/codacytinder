...
public final class Method extends GeneratedMessageV3 implements MethodOrBuilder {
    ...
    private static final Parser<Method> PARSER = new C77851();
    ...
    static class C77851 extends AbstractParser<Method> {
        C77851() {
        }
    ...
    public static final class Builder extends com.google.protobuf.GeneratedMessageV3.Builder<Builder> implements MethodOrBuilder {
        ...
        public Builder mergeFrom(CodedInputStream codedInputStream, ExtensionRegistryLite extensionRegistryLite) throws IOException {
            ...
            try {
                ...
                method = (Method) codedInputStream2.getUnfinishedMessage();
    ...
    public int getSerializedSize() {
        ...
        while (i2 < this.options_.size()) {
            i += CodedOutputStream.computeMessageSize(6, (MessageLite) this.options_.get(i2));
            i2++;
        }
        if (this.syntax_ != Syntax.SYNTAX_PROTO2.getNumber()) {
    ...
    public boolean equals(Object obj) {
        ...
        Object obj2 = ((getName().equals(method.getName()) ? 1 : null) == null || !getRequestTypeUrl().equals(method.getRequestTypeUrl())) ? null : 1;
        obj2 = (obj2 == null || getRequestStreaming() != method.getRequestStreaming()) ? null : 1;
        obj2 = (obj2 == null || !getResponseTypeUrl().equals(method.getResponseTypeUrl())) ? null : 1;
        obj2 = (obj2 == null || getResponseStreaming() != method.getResponseStreaming()) ? null : 1;
        obj2 = (obj2 == null || !getOptionsList().equals(method.getOptionsList())) ? null : 1;
        obj2 = (obj2 == null || this.syntax_ != method.syntax_) ? null : 1;
        if (obj2 == null || this.unknownFields.equals(method.unknownFields) == null) {
            z = false;
        }
        return z;
    }
