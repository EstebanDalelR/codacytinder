...
public abstract class GeneratedMessageV3 extends AbstractMessage implements Serializable {
    ...
    public static final class FieldAccessorTable {
        ...
        private static class OneofAccessor {
            ...
            OneofAccessor(Descriptor descriptor, String str, Class<? extends GeneratedMessageV3> cls, Class<? extends Builder> cls2) {
                ...
                this.caseMethod = GeneratedMessageV3.getMethodOrDie(cls, descriptor.toString(), new Class[0]);
                descriptor = new StringBuilder();
                descriptor.append("get");
                descriptor.append(str);
                descriptor.append("Case");
                this.caseMethodBuilder = GeneratedMessageV3.getMethodOrDie(cls2, descriptor.toString(), new Class[0]);
                descriptor = new StringBuilder();
                descriptor.append("clear");
                descriptor.append(str);
                this.clearMethod = GeneratedMessageV3.getMethodOrDie(cls2, descriptor.toString(), new Class[0]);
            }

            public boolean has(GeneratedMessageV3 generatedMessageV3) {
                return ((EnumLite) GeneratedMessageV3.invokeOrDie(this.caseMethod, generatedMessageV3, new Object[0])).getNumber() != null;
            }

            public boolean has(Builder builder) {
                return ((EnumLite) GeneratedMessageV3.invokeOrDie(this.caseMethodBuilder, builder, new Object[0])).getNumber() != null;
            }

            public FieldDescriptor get(GeneratedMessageV3 generatedMessageV3) {
                generatedMessageV3 = ((EnumLite) GeneratedMessageV3.invokeOrDie(this.caseMethod, generatedMessageV3, new Object[0])).getNumber();
                return generatedMessageV3 > null ? this.descriptor.findFieldByNumber(generatedMessageV3) : null;
            }

            public FieldDescriptor get(Builder builder) {
                builder = ((EnumLite) GeneratedMessageV3.invokeOrDie(this.caseMethodBuilder, builder, new Object[0])).getNumber();
        ...
        private static class RepeatedFieldAccessor implements FieldAccessor {
            ...
            RepeatedFieldAccessor(FieldDescriptor fieldDescriptor, String str, Class<? extends GeneratedMessageV3> cls, Class<? extends Builder> cls2) {
                ...
                this.getMethod = GeneratedMessageV3.getMethodOrDie(cls, fieldDescriptor.toString(), new Class[0]);
                fieldDescriptor = new StringBuilder();
                fieldDescriptor.append("get");
                fieldDescriptor.append(str);
                fieldDescriptor.append("List");
                this.getMethodBuilder = GeneratedMessageV3.getMethodOrDie(cls2, fieldDescriptor.toString(), new Class[0]);
                fieldDescriptor = new StringBuilder();
                fieldDescriptor.append("get");
                fieldDescriptor.append(str);
                this.getRepeatedMethod = GeneratedMessageV3.getMethodOrDie(cls, fieldDescriptor.toString(), Integer.TYPE);
                fieldDescriptor = new StringBuilder();
                fieldDescriptor.append("get");
                fieldDescriptor.append(str);
                this.getRepeatedMethodBuilder = GeneratedMessageV3.getMethodOrDie(cls2, fieldDescriptor.toString(), Integer.TYPE);
                fieldDescriptor = new StringBuilder();
                fieldDescriptor.append("set");
                fieldDescriptor.append(str);
                this.setRepeatedMethod = GeneratedMessageV3.getMethodOrDie(cls2, fieldDescriptor.toString(), Integer.TYPE, this.type);
                fieldDescriptor = new StringBuilder();
                fieldDescriptor.append("add");
                fieldDescriptor.append(str);
                this.addRepeatedMethod = GeneratedMessageV3.getMethodOrDie(cls2, fieldDescriptor.toString(), this.type);
                fieldDescriptor = new StringBuilder();
                fieldDescriptor.append("get");
                fieldDescriptor.append(str);
                fieldDescriptor.append("Count");
                this.getCountMethod = GeneratedMessageV3.getMethodOrDie(cls, fieldDescriptor.toString(), new Class[0]);
                fieldDescriptor = new StringBuilder();
                fieldDescriptor.append("get");
                fieldDescriptor.append(str);
                fieldDescriptor.append("Count");
                this.getCountMethodBuilder = GeneratedMessageV3.getMethodOrDie(cls2, fieldDescriptor.toString(), new Class[0]);
                fieldDescriptor = new StringBuilder();
                fieldDescriptor.append("clear");
                fieldDescriptor.append(str);
                this.clearMethod = GeneratedMessageV3.getMethodOrDie(cls2, fieldDescriptor.toString(), new Class[0]);
            }
        ...
        private static class SingularFieldAccessor implements FieldAccessor {
            ...
            SingularFieldAccessor(FieldDescriptor fieldDescriptor, String str, Class<? extends GeneratedMessageV3> cls, Class<? extends Builder> cls2, String str2) {
                ...
                if (!FieldAccessorTable.supportFieldPresence(fieldDescriptor.getFile())) {
                    if (this.isOneofField || fieldDescriptor.getJavaType() != JavaType.MESSAGE) {
                        ...
                        fieldDescriptor.append("set");
                        fieldDescriptor.append(str);
                        this.setMethod = GeneratedMessageV3.getMethodOrDie(cls2, fieldDescriptor.toString(), this.type);
                        method = null;
                        if (this.hasHasMethod == null) {
                            fieldDescriptor = new StringBuilder();
                            fieldDescriptor.append("has");
                            fieldDescriptor.append(str);
                            fieldDescriptor = GeneratedMessageV3.getMethodOrDie(cls, fieldDescriptor.toString(), new Class[0]);
                        } else {
                            fieldDescriptor = null;
                        }
                        ...
                        if (this.hasHasMethod == null) {
                            ...
                            fieldDescriptor.append("has");
                            fieldDescriptor.append(str);
                            fieldDescriptor = GeneratedMessageV3.getMethodOrDie(cls2, fieldDescriptor.toString(), new Class[0]);
                        } else {
                            fieldDescriptor = null;
                        }
                        ...
                        if (this.isOneofField != null) {
                            ...
                            fieldDescriptor.append(str2);
                            fieldDescriptor.append("Case");
                            method = GeneratedMessageV3.getMethodOrDie(cls2, fieldDescriptor.toString(), new Class[0]);
                        }
            ...
            public boolean has(GeneratedMessageV3 generatedMessageV3) {
                ...
                if (!this.isOneofField) {
                    return get(generatedMessageV3).equals(this.field.getDefaultValue()) ^ 1;
                }
        ...
        private static final class RepeatedEnumFieldAccessor extends RepeatedFieldAccessor {
            ...
            RepeatedEnumFieldAccessor(FieldDescriptor fieldDescriptor, String str, Class<? extends GeneratedMessageV3> cls, Class<? extends Builder> cls2) {
                ...
                if (this.supportUnknownEnumValue != null) {
                    ...
                    this.getRepeatedValueMethod = GeneratedMessageV3.getMethodOrDie(cls, fieldDescriptor.toString(), Integer.TYPE);
                    fieldDescriptor = new StringBuilder();
                    fieldDescriptor.append("get");
                    fieldDescriptor.append(str);
                    fieldDescriptor.append("Value");
                    this.getRepeatedValueMethodBuilder = GeneratedMessageV3.getMethodOrDie(cls2, fieldDescriptor.toString(), new Class[]{Integer.TYPE});
                    fieldDescriptor = new StringBuilder();
                    fieldDescriptor.append("set");
                    fieldDescriptor.append(str);
                    fieldDescriptor.append("Value");
                    this.setRepeatedValueMethod = GeneratedMessageV3.getMethodOrDie(cls2, fieldDescriptor.toString(), new Class[]{Integer.TYPE, Integer.TYPE});
                    fieldDescriptor = new StringBuilder();
                    fieldDescriptor.append("add");
                    fieldDescriptor.append(str);
                    fieldDescriptor.append("Value");
                    this.addRepeatedValueMethod = GeneratedMessageV3.getMethodOrDie(cls2, fieldDescriptor.toString(), new Class[]{Integer.TYPE});
                }
            }
        ...
        private static final class RepeatedMessageFieldAccessor extends RepeatedFieldAccessor {
            ...
            RepeatedMessageFieldAccessor(FieldDescriptor fieldDescriptor, String str, Class<? extends GeneratedMessageV3> cls, Class<? extends Builder> cls2) {
                ...
                this.getBuilderMethodBuilder = GeneratedMessageV3.getMethodOrDie(cls2, fieldDescriptor.toString(), new Class[]{Integer.TYPE});
            }
        ...
        private static final class SingularEnumFieldAccessor extends SingularFieldAccessor {
            ...
            SingularEnumFieldAccessor(FieldDescriptor fieldDescriptor, String str, Class<? extends GeneratedMessageV3> cls, Class<? extends Builder> cls2, String str2) {
                ...
                if (this.supportUnknownEnumValue != null) {
                    ...
                    fieldDescriptor.append(str);
                    fieldDescriptor.append("Value");
                    this.getValueMethod = GeneratedMessageV3.getMethodOrDie(cls, fieldDescriptor.toString(), new Class[0]);
                    fieldDescriptor = new StringBuilder();
                    fieldDescriptor.append("get");
                    fieldDescriptor.append(str);
                    fieldDescriptor.append("Value");
                    this.getValueMethodBuilder = GeneratedMessageV3.getMethodOrDie(cls2, fieldDescriptor.toString(), new Class[0]);
                    fieldDescriptor = new StringBuilder();
                    fieldDescriptor.append("set");
                    fieldDescriptor.append(str);
                    fieldDescriptor.append("Value");
                    this.setValueMethod = GeneratedMessageV3.getMethodOrDie(cls2, fieldDescriptor.toString(), new Class[]{Integer.TYPE});
                }
            }
        ...
        private static final class SingularMessageFieldAccessor extends SingularFieldAccessor {
            ...
            SingularMessageFieldAccessor(FieldDescriptor fieldDescriptor, String str, Class<? extends GeneratedMessageV3> cls, Class<? extends Builder> cls2, String str2) {
                ...
                fieldDescriptor.append(str);
                fieldDescriptor.append("Builder");
                this.getBuilderMethodBuilder = GeneratedMessageV3.getMethodOrDie(cls2, fieldDescriptor.toString(), new Class[0]);
            }
        ...
        private static final class SingularStringFieldAccessor extends SingularFieldAccessor {
            ...
            SingularStringFieldAccessor(FieldDescriptor fieldDescriptor, String str, Class<? extends GeneratedMessageV3> cls, Class<? extends Builder> cls2, String str2) {
                ...
                this.getBytesMethod = GeneratedMessageV3.getMethodOrDie(cls, fieldDescriptor.toString(), new Class[0]);
                fieldDescriptor = new StringBuilder();
                fieldDescriptor.append("get");
                fieldDescriptor.append(str);
                fieldDescriptor.append("Bytes");
                this.getBytesMethodBuilder = GeneratedMessageV3.getMethodOrDie(cls2, fieldDescriptor.toString(), new Class[0]);
                fieldDescriptor = new StringBuilder();
                fieldDescriptor.append("set");
                fieldDescriptor.append(str);
                fieldDescriptor.append("Bytes");
                this.setBytesMethodBuilder = GeneratedMessageV3.getMethodOrDie(cls2, fieldDescriptor.toString(), new Class[]{ByteString.class});
            }
    ...
    public static abstract class ExtendableBuilder<MessageType extends ExtendableMessage, BuilderType extends ExtendableBuilder<MessageType, BuilderType>> extends Builder<BuilderType> implements ExtendableMessageOrBuilder<MessageType> {
        ...
        public final <Type> boolean hasExtension(ExtensionLite<MessageType, Type> extensionLite) {
            extensionLite = GeneratedMessageV3.checkNotLite(extensionLite);
    ...
    protected boolean parseUnknownField(CodedInputStream codedInputStream, com.google.protobuf.UnknownFieldSet.Builder builder, ExtensionRegistryLite extensionRegistryLite, int i) throws IOException {
        if (codedInputStream.shouldDiscardUnknownFields() != null) {
    ...
    protected boolean parseUnknownFieldProto3(CodedInputStream codedInputStream, com.google.protobuf.UnknownFieldSet.Builder builder, ExtensionRegistryLite extensionRegistryLite, int i) throws IOException {
        if (codedInputStream.shouldDiscardUnknownFieldsProto3() != null) {
            return codedInputStream.skipField(i);
        }
        return builder.mergeFieldFrom(i, codedInputStream);
    }
    ...
    protected static <V> void serializeIntegerMapTo(CodedOutputStream codedOutputStream, MapField<Integer, V> mapField, MapEntry<Integer, V> mapEntry, int i) throws IOException {
        mapField = mapField.getMap();
        if (codedOutputStream.isSerializationDeterministic()) {
            int[] iArr = new int[mapField.size()];
            int i2 = 0;
            for (Integer intValue : mapField.keySet()) {
                int i3 = i2 + 1;
            ...
            Arrays.sort(iArr);
            for (int i22 : iArr) {
                codedOutputStream.writeMessage(i, mapEntry.newBuilderForType().setKey(Integer.valueOf(i22)).setValue(mapField.get(Integer.valueOf(i22))).build());
            }
            return;
        }
        serializeMapTo(codedOutputStream, mapField, mapEntry, i);
    }
    ...
    protected static <V> void serializeLongMapTo(CodedOutputStream codedOutputStream, MapField<Long, V> mapField, MapEntry<Long, V> mapEntry, int i) throws IOException {
        mapField = mapField.getMap();
        if (codedOutputStream.isSerializationDeterministic()) {
            long[] jArr = new long[mapField.size()];
            int i2 = 0;
            for (Long longValue : mapField.keySet()) {
                int i3 = i2 + 1;
            ...
            Arrays.sort(jArr);
            for (long j : jArr) {
                codedOutputStream.writeMessage(i, mapEntry.newBuilderForType().setKey(Long.valueOf(j)).setValue(mapField.get(Long.valueOf(j))).build());
            }
            return;
        }
        serializeMapTo(codedOutputStream, mapField, mapEntry, i);
    ...
    protected static <V> void serializeStringMapTo(CodedOutputStream codedOutputStream, MapField<String, V> mapField, MapEntry<String, V> mapEntry, int i) throws IOException {
        mapField = mapField.getMap();
        if (codedOutputStream.isSerializationDeterministic()) {
            String[] strArr = (String[]) mapField.keySet().toArray(new String[mapField.size()]);
            Arrays.sort(strArr);
            for (Object obj : strArr) {
                codedOutputStream.writeMessage(i, mapEntry.newBuilderForType().setKey(obj).setValue(mapField.get(obj)).build());
            }
            return;
        }
        serializeMapTo(codedOutputStream, mapField, mapEntry, i);
    ...
    protected static <V> void serializeBooleanMapTo(CodedOutputStream codedOutputStream, MapField<Boolean, V> mapField, MapEntry<Boolean, V> mapEntry, int i) throws IOException {
        mapField = mapField.getMap();
        if (codedOutputStream.isSerializationDeterministic()) {
            maybeSerializeBooleanEntryTo(codedOutputStream, mapField, mapEntry, i, false);
            maybeSerializeBooleanEntryTo(codedOutputStream, mapField, mapEntry, i, true);
            return;
        }
        serializeMapTo(codedOutputStream, mapField, mapEntry, i);
    }
