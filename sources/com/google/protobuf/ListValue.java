...
public final class ListValue extends GeneratedMessageV3 implements ListValueOrBuilder {
    ...
    private static final Parser<ListValue> PARSER = new C77831();
    ...
    static class C77831 extends AbstractParser<ListValue> {
        C77831() {
        }
    ...
    public static final class Builder extends com.google.protobuf.GeneratedMessageV3.Builder<Builder> implements ListValueOrBuilder {
        ...
        public Builder mergeFrom(CodedInputStream codedInputStream, ExtensionRegistryLite extensionRegistryLite) throws IOException {
            ...
            try {
                ...
                listValue = (ListValue) codedInputStream2.getUnfinishedMessage();
        ...
        public Builder addAllValues(Iterable<? extends Value> iterable) {
            if (this.valuesBuilder_ == null) {
                ensureValuesIsMutable();
                com.google.protobuf.AbstractMessageLite.Builder.addAll((Iterable) iterable, this.values_);
                onChanged();
            } else {
    ...
    public boolean equals(Object obj) {
        ...
        if ((getValuesList().equals(listValue.getValuesList()) ? 1 : null) == null || this.unknownFields.equals(listValue.unknownFields) == null) {
            z = false;
        }
        return z;
    }
