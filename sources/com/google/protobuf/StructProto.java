...
public final class StructProto {
    ...
    static final FieldAccessorTable f20929xe21f65a0 = new FieldAccessorTable(internal_static_google_protobuf_Struct_FieldsEntry_descriptor, new String[]{"Key", "Value"});
    ...
    static class C69761 implements InternalDescriptorAssigner {
        C69761() {
        }
