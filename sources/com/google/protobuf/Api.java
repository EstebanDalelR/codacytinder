...
public final class Api extends GeneratedMessageV3 implements ApiOrBuilder {
    ...
    private static final Parser<Api> PARSER = new C77371();
    ...
    static class C77371 extends AbstractParser<Api> {
        C77371() {
        }
    ...
    public static final class Builder extends com.google.protobuf.GeneratedMessageV3.Builder<Builder> implements ApiOrBuilder {
        ...
        public Builder mergeFrom(CodedInputStream codedInputStream, ExtensionRegistryLite extensionRegistryLite) throws IOException {
            ...
            try {
                ...
                api = (Api) codedInputStream2.getUnfinishedMessage();
        ...
        public Builder addAllMethods(Iterable<? extends Method> iterable) {
            if (this.methodsBuilder_ == null) {
                ensureMethodsIsMutable();
                com.google.protobuf.AbstractMessageLite.Builder.addAll((Iterable) iterable, this.methods_);
                onChanged();
            } else {
        ...
        public Builder addAllMixins(Iterable<? extends Mixin> iterable) {
            if (this.mixinsBuilder_ == null) {
                ensureMixinsIsMutable();
                com.google.protobuf.AbstractMessageLite.Builder.addAll((Iterable) iterable, this.mixins_);
                onChanged();
            } else {
    ...
    public int getSerializedSize() {
        ...
        for (i = 0; i < this.methods_.size(); i++) {
            computeStringSize += CodedOutputStream.computeMessageSize(2, (MessageLite) this.methods_.get(i));
        }
        for (i = 0; i < this.options_.size(); i++) {
            computeStringSize += CodedOutputStream.computeMessageSize(3, (MessageLite) this.options_.get(i));
        }
        if (!getVersionBytes().isEmpty()) {
        ...
        while (i2 < this.mixins_.size()) {
            computeStringSize += CodedOutputStream.computeMessageSize(6, (MessageLite) this.mixins_.get(i2));
            i2++;
        }
        if (this.syntax_ != Syntax.SYNTAX_PROTO2.getNumber()) {
    ...
    public boolean equals(Object obj) {
        ...
        Api api = (Api) obj;
        Object obj2 = ((getName().equals(api.getName()) ? 1 : null) == null || !getMethodsList().equals(api.getMethodsList())) ? null : 1;
        obj2 = (obj2 == null || !getOptionsList().equals(api.getOptionsList())) ? null : 1;
        obj2 = (obj2 == null || !getVersion().equals(api.getVersion())) ? null : 1;
        obj2 = (obj2 == null || hasSourceContext() != api.hasSourceContext()) ? null : 1;
        if (hasSourceContext()) {
            obj2 = (obj2 == null || !getSourceContext().equals(api.getSourceContext())) ? null : 1;
        }
        obj2 = (obj2 == null || !getMixinsList().equals(api.getMixinsList())) ? null : 1;
        obj2 = (obj2 == null || this.syntax_ != api.syntax_) ? null : 1;
        if (obj2 == null || this.unknownFields.equals(api.unknownFields) == null) {
            z = false;
        }
        return z;
    }
