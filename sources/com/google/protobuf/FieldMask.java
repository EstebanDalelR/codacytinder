...
public final class FieldMask extends GeneratedMessageV3 implements FieldMaskOrBuilder {
    ...
    private static final Parser<FieldMask> PARSER = new C77741();
    ...
    static class C77741 extends AbstractParser<FieldMask> {
        C77741() {
        }
    ...
    public static final class Builder extends com.google.protobuf.GeneratedMessageV3.Builder<Builder> implements FieldMaskOrBuilder {
        ...
        public Builder mergeFrom(CodedInputStream codedInputStream, ExtensionRegistryLite extensionRegistryLite) throws IOException {
            ...
            try {
                ...
                fieldMask = (FieldMask) codedInputStream2.getUnfinishedMessage();
        ...
        public Builder addAllPaths(Iterable<String> iterable) {
            ensurePathsIsMutable();
            com.google.protobuf.AbstractMessageLite.Builder.addAll((Iterable) iterable, this.paths_);
            onChanged();
            return this;
        }
    ...
    public int getSerializedSize() {
        ...
        i2 = ((i2 + 0) + (getPathsList().size() * 1)) + this.unknownFields.getSerializedSize();
    ...
    public boolean equals(Object obj) {
        ...
        if ((getPathsList().equals(fieldMask.getPathsList()) ? 1 : null) == null || this.unknownFields.equals(fieldMask.unknownFields) == null) {
            z = false;
        }
        return z;
    }
