...
class SmallSortedMap<K extends Comparable<K>, V> extends AbstractMap<K, V> {
    ...
    private static class EmptySet {
        private static final Iterable<Object> ITERABLE = new C56432();
        private static final Iterator<Object> ITERATOR = new C56421();

        /* renamed from: com.google.protobuf.SmallSortedMap$EmptySet$1 */
        static class C56421 implements Iterator<Object> {
        ...
        static class C56432 implements Iterable<Object> {
            C56432() {
            }
