...
public final class LinkedTreeMap<K, V> extends AbstractMap<K, V> implements Serializable {
    ...
    private static final Comparator<Comparable> NATURAL_ORDER = new C56121();
    ...
    static class C56121 implements Comparator<Comparable> {
        C56121() {
        }
    ...
    class EntrySet extends AbstractSet<Entry<K, V>> {
        ...
        class C69201 extends LinkedTreeMapIterator<Entry<K, V>> {
            C69201() {
                super();
            }
    ...
    final class KeySet extends AbstractSet<K> {
        ...
        class C69211 extends LinkedTreeMapIterator<K> {
            C69211() {
                super();
            }
