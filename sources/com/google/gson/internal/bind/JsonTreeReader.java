...
public final class JsonTreeReader extends JsonReader {
    ...
    private static final Reader UNREADABLE_READER = new C56131();
    ...
    static class C56131 extends Reader {
        C56131() {
        }
    ...
    public void skipValue() throws IOException {
        if (peek() == JsonToken.NAME) {
            nextName();
            this.pathNames[this.stackSize - 2] = ManagerWebServices.NULL_STRING_VALUE;
        } else {
            popStack();
            if (this.stackSize > 0) {
                this.pathNames[this.stackSize - 1] = ManagerWebServices.NULL_STRING_VALUE;
            }
        }
        if (this.stackSize > 0) {
            int[] iArr = this.pathIndices;
