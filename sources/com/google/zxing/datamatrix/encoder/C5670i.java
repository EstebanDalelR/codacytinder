...
public final class C5670i {
    /* renamed from: a */
    private static final int[] f21013a = new int[]{5, 7, 10, 11, 12, 14, 18, 20, 24, 28, 36, 42, 48, 56, 62, 68};
    /* renamed from: b */
    private static final int[][] f21014b;
    /* renamed from: c */
    private static final int[] f21015c = new int[256];
    /* renamed from: d */
    private static final int[] f21016d = new int[255];
    ...
    /* renamed from: a */
    public static String m24811a(String str, C5672k c5672k) {
        if (str.length() != c5672k.m24837f()) {
            throw new IllegalArgumentException("The number of codewords does not match the selected symbol");
        }
        StringBuilder stringBuilder = new StringBuilder(c5672k.m24837f() + c5672k.m24838g());
        stringBuilder.append(str);
        int a = c5672k.mo6178a();
        if (a == 1) {
            stringBuilder.append(C5670i.m24809a((CharSequence) str, c5672k.m24838g()));
        } else {
            int i;
            ...
            while (i2 < a) {
                i = i2 + 1;
                iArr[i2] = c5672k.mo6179a(i);
                iArr2[i2] = c5672k.m24833b(i);
                iArr3[i2] = 0;
                if (i2 > 0) {
            ...
            for (int i3 = 0; i3 < a; i3++) {
                ...
                for (i = i3; i < c5672k.m24837f(); i += a) {
                    stringBuilder2.append(str.charAt(i));
                }
                String a2 = C5670i.m24809a(stringBuilder2.toString(), iArr2[i3]);
                i = i3;
                int i4 = 0;
                while (i < iArr2[i3] * a) {
                    int i5 = i4 + 1;
                    stringBuilder.setCharAt(c5672k.m24837f() + i, a2.charAt(i4));
                    i += a;
                    i4 = i5;
                }
            }
    ...
    /* renamed from: a */
    private static String m24809a(CharSequence charSequence, int i) {
        return C5670i.m24810a(charSequence, 0, charSequence.length(), i);
    }

    /* renamed from: a */
    private static String m24810a(CharSequence charSequence, int i, int i2, int i3) {
        int i4 = 0;
        int i5 = 0;
        while (i5 < f21013a.length) {
            if (f21013a[i5] == i3) {
                break;
            }
            i5++;
        ...
        i5 = -1;
        if (i5 < 0) {
            i = new StringBuilder("Illegal number of error correction codewords specified: ");
            i.append(i3);
        ...
        for (i6 = i; i6 < i + i2; i6++) {
            ...
            while (i7 > 0) {
                if (charAt == 0 || iArr[i7] == 0) {
                    ...
                    cArr[i7] = (char) (cArr[i7 - 1] ^ f21016d[(f21015c[charAt] + f21015c[iArr[i7]]) % 255]);
                }
                i7--;
            }
            if (charAt == 0 || iArr[0] == 0) {
                ...
                cArr[0] = (char) f21016d[(f21015c[charAt] + f21015c[iArr[0]]) % 255];
            }
        }
