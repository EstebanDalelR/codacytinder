...
public final class PhotoItemView$$special$$inlined$bindView$3 extends Lambda implements Function0<TextView> {
    /* renamed from: a */
    final /* synthetic */ View f14638a;
    /* renamed from: b */
    final /* synthetic */ int f14639b;

    public PhotoItemView$$special$$inlined$bindView$3(View view, int i) {
        this.f14638a = view;
        this.f14639b = i;
        super(0);
    }
    ...
    @NotNull
    /* renamed from: a */
    public final TextView m18179a() {
        View findViewById = this.f14638a.findViewById(this.f14639b);
        ...
        stringBuilder.append(this.f14639b);
