...
public final class NewMatchFeedView$$special$$inlined$bindView$2 extends Lambda implements Function0<FeedFooterView> {
    /* renamed from: a */
    final /* synthetic */ View f44234a;
    /* renamed from: b */
    final /* synthetic */ int f44235b;

    public NewMatchFeedView$$special$$inlined$bindView$2(View view, int i) {
        this.f44234a = view;
        this.f44235b = i;
        super(0);
    }
    ...
    @NotNull
    /* renamed from: a */
    public final FeedFooterView m53578a() {
        View findViewById = this.f44234a.findViewById(this.f44235b);
        ...
        stringBuilder.append(this.f44235b);
