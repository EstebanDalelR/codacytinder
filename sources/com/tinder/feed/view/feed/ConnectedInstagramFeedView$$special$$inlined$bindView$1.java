...
public final class ConnectedInstagramFeedView$$special$$inlined$bindView$1 extends Lambda implements Function0<FeedInfoView> {
    /* renamed from: a */
    final /* synthetic */ View f44180a;
    /* renamed from: b */
    final /* synthetic */ int f44181b;

    public ConnectedInstagramFeedView$$special$$inlined$bindView$1(View view, int i) {
        this.f44180a = view;
        this.f44181b = i;
        super(0);
    }
    ...
    @NotNull
    /* renamed from: a */
    public final FeedInfoView m53548a() {
        View findViewById = this.f44180a.findViewById(this.f44181b);
        ...
        stringBuilder.append(this.f44181b);
