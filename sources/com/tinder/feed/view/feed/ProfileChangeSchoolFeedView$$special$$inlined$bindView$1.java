...
public final class ProfileChangeSchoolFeedView$$special$$inlined$bindView$1 extends Lambda implements Function0<FeedInfoView> {
    /* renamed from: a */
    final /* synthetic */ View f44284a;
    /* renamed from: b */
    final /* synthetic */ int f44285b;

    public ProfileChangeSchoolFeedView$$special$$inlined$bindView$1(View view, int i) {
        this.f44284a = view;
        this.f44285b = i;
        super(0);
    }
    ...
    @NotNull
    /* renamed from: a */
    public final FeedInfoView m53605a() {
        View findViewById = this.f44284a.findViewById(this.f44285b);
        ...
        stringBuilder.append(this.f44285b);
