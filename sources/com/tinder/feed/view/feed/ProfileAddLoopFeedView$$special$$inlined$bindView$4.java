...
public final class ProfileAddLoopFeedView$$special$$inlined$bindView$4 extends Lambda implements Function0<FeedCommentView> {
    /* renamed from: a */
    final /* synthetic */ View f44251a;
    /* renamed from: b */
    final /* synthetic */ int f44252b;

    public ProfileAddLoopFeedView$$special$$inlined$bindView$4(View view, int i) {
        this.f44251a = view;
        this.f44252b = i;
        super(0);
    }
    ...
    @NotNull
    /* renamed from: a */
    public final FeedCommentView m53587a() {
        View findViewById = this.f44251a.findViewById(this.f44252b);
        ...
        stringBuilder.append(this.f44252b);
