...
public final class ProfileAddPhotoFeedView$$special$$inlined$bindView$2 extends Lambda implements Function0<FeedFooterView> {
    /* renamed from: a */
    final /* synthetic */ View f44260a;
    /* renamed from: b */
    final /* synthetic */ int f44261b;

    public ProfileAddPhotoFeedView$$special$$inlined$bindView$2(View view, int i) {
        this.f44260a = view;
        this.f44261b = i;
        super(0);
    }
    ...
    @NotNull
    /* renamed from: a */
    public final FeedFooterView m53592a() {
        View findViewById = this.f44260a.findViewById(this.f44261b);
        ...
        stringBuilder.append(this.f44261b);
