...
public final class NewMatchFeedView$$special$$inlined$bindView$5 extends Lambda implements Function0<FeedCommentView> {
    /* renamed from: a */
    final /* synthetic */ View f44240a;
    /* renamed from: b */
    final /* synthetic */ int f44241b;

    public NewMatchFeedView$$special$$inlined$bindView$5(View view, int i) {
        this.f44240a = view;
        this.f44241b = i;
        super(0);
    }
    ...
    @NotNull
    /* renamed from: a */
    public final FeedCommentView m53581a() {
        View findViewById = this.f44240a.findViewById(this.f44241b);
        ...
        stringBuilder.append(this.f44241b);
