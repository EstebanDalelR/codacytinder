...
public final class FeedCommentView$$special$$inlined$bindView$3 extends Lambda implements Function0<View> {
    /* renamed from: a */
    final /* synthetic */ View f44382a;
    /* renamed from: b */
    final /* synthetic */ int f44383b;

    public FeedCommentView$$special$$inlined$bindView$3(View view, int i) {
        this.f44382a = view;
        this.f44383b = i;
        super(0);
    }
    ...
    @NotNull
    /* renamed from: a */
    public final View m53657a() {
        View findViewById = this.f44382a.findViewById(this.f44383b);
        ...
        stringBuilder.append(this.f44383b);
