...
public final class FeedCommentView$$special$$inlined$bindView$5 extends Lambda implements Function0<TextView> {
    /* renamed from: a */
    final /* synthetic */ View f44386a;
    /* renamed from: b */
    final /* synthetic */ int f44387b;

    public FeedCommentView$$special$$inlined$bindView$5(View view, int i) {
        this.f44386a = view;
        this.f44387b = i;
        super(0);
    }
    ...
    @NotNull
    /* renamed from: a */
    public final TextView m53659a() {
        View findViewById = this.f44386a.findViewById(this.f44387b);
        ...
        stringBuilder.append(this.f44387b);
