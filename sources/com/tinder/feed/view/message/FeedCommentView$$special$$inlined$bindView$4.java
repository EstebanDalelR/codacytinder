...
public final class FeedCommentView$$special$$inlined$bindView$4 extends Lambda implements Function0<TextView> {
    /* renamed from: a */
    final /* synthetic */ View f44384a;
    /* renamed from: b */
    final /* synthetic */ int f44385b;

    public FeedCommentView$$special$$inlined$bindView$4(View view, int i) {
        this.f44384a = view;
        this.f44385b = i;
        super(0);
    }
    ...
    @NotNull
    /* renamed from: a */
    public final TextView m53658a() {
        View findViewById = this.f44384a.findViewById(this.f44385b);
        ...
        stringBuilder.append(this.f44385b);
