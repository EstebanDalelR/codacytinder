...
public final class FeedInstagramMediaView$$special$$inlined$bindView$1 extends Lambda implements Function0<FeedCarouselView> {
    /* renamed from: a */
    final /* synthetic */ View f44354a;
    /* renamed from: b */
    final /* synthetic */ int f44355b;

    public FeedInstagramMediaView$$special$$inlined$bindView$1(View view, int i) {
        this.f44354a = view;
        this.f44355b = i;
        super(0);
    }
    ...
    @NotNull
    /* renamed from: a */
    public final FeedCarouselView m53642a() {
        View findViewById = this.f44354a.findViewById(this.f44355b);
        ...
        stringBuilder.append(this.f44355b);
