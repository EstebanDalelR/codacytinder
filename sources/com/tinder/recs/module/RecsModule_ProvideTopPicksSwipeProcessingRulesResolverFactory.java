...
public final class RecsModule_ProvideTopPicksSwipeProcessingRulesResolverFactory implements Factory<SwipeProcessingRulesResolver> {
    ...
    public RecsModule_ProvideTopPicksSwipeProcessingRulesResolverFactory(RecsModule recsModule, Provider<SwipeDispatchRule> provider, Provider<DupesPreventionRule> provider2, Provider<UserRecSwipeAnalyticsRule> provider3) {
    ...
    public static SwipeProcessingRulesResolver provideInstance(RecsModule recsModule, Provider<SwipeDispatchRule> provider, Provider<DupesPreventionRule> provider2, Provider<UserRecSwipeAnalyticsRule> provider3) {
        return proxyProvideTopPicksSwipeProcessingRulesResolver(recsModule, C17281c.m63230b(provider), C17281c.m63230b(provider2), C17281c.m63230b(provider3));
    }

    public static RecsModule_ProvideTopPicksSwipeProcessingRulesResolverFactory create(RecsModule recsModule, Provider<SwipeDispatchRule> provider, Provider<DupesPreventionRule> provider2, Provider<UserRecSwipeAnalyticsRule> provider3) {
        return new RecsModule_ProvideTopPicksSwipeProcessingRulesResolverFactory(recsModule, provider, provider2, provider3);
    }

    public static SwipeProcessingRulesResolver proxyProvideTopPicksSwipeProcessingRulesResolver(RecsModule recsModule, Lazy<SwipeDispatchRule> lazy, Lazy<DupesPreventionRule> lazy2, Lazy<UserRecSwipeAnalyticsRule> lazy3) {
        return (SwipeProcessingRulesResolver) C15521i.m58001a(recsModule.provideTopPicksSwipeProcessingRulesResolver(lazy, lazy2, lazy3), "Cannot return null from a non-@Nullable @Provides method");
    }
}
