...
final class RecsPresenter$observeSwipeRatingStatus$3<T, R> implements Func1<Ended, Boolean> {
    final /* synthetic */ RecsPresenter this$0;

    RecsPresenter$observeSwipeRatingStatus$3(RecsPresenter recsPresenter) {
    ...
    public final boolean call(Ended ended) {
        ...
        C2668g.a(ended, "it");
        return recsPresenter.shouldRewind(ended);
    }
}
