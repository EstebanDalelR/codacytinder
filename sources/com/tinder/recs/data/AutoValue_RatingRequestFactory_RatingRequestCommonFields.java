...
final class AutoValue_RatingRequestFactory_RatingRequestCommonFields extends RatingRequestCommonFields {
    ...
    static final class Builder extends com.tinder.recs.data.RatingRequestFactory.RatingRequestCommonFields.Builder {
        ...
        Builder(RatingRequestCommonFields ratingRequestCommonFields) {
            ...
            this.isTopPicks = ratingRequestCommonFields.isTopPicks();
            this.isUndo = ratingRequestCommonFields.isUndo();
            this.placeId = ratingRequestCommonFields.placeId();
            this.sNumber = ratingRequestCommonFields.sNumber();
        }

        public com.tinder.recs.data.RatingRequestFactory.RatingRequestCommonFields.Builder recId(String str) {
            this.recId = str;
            return this;
        }

        public com.tinder.recs.data.RatingRequestFactory.RatingRequestCommonFields.Builder photoId(@Nullable String str) {
            this.photoId = str;
            return this;
        }

        public com.tinder.recs.data.RatingRequestFactory.RatingRequestCommonFields.Builder contentHash(@Nullable String str) {
            this.contentHash = str;
            return this;
        }

        public com.tinder.recs.data.RatingRequestFactory.RatingRequestCommonFields.Builder didRecUserSuperlike(@Nullable Boolean bool) {
            this.didRecUserSuperlike = bool;
            return this;
        }

        public com.tinder.recs.data.RatingRequestFactory.RatingRequestCommonFields.Builder wasRecUserPassporting(@Nullable Boolean bool) {
            this.wasRecUserPassporting = bool;
            return this;
        }

        public com.tinder.recs.data.RatingRequestFactory.RatingRequestCommonFields.Builder isCurrentUserPassporting(@Nullable Boolean bool) {
            this.isCurrentUserPassporting = bool;
            return this;
        }

        public com.tinder.recs.data.RatingRequestFactory.RatingRequestCommonFields.Builder isCurrentUserBoosting(@Nullable Boolean bool) {
            this.isCurrentUserBoosting = bool;
            return this;
        }

        public com.tinder.recs.data.RatingRequestFactory.RatingRequestCommonFields.Builder isFastMatch(@Nullable Boolean bool) {
            this.isFastMatch = bool;
            return this;
        }

        public com.tinder.recs.data.RatingRequestFactory.RatingRequestCommonFields.Builder isTopPicks(@Nullable Boolean bool) {
            this.isTopPicks = bool;
            return this;
        }

        public com.tinder.recs.data.RatingRequestFactory.RatingRequestCommonFields.Builder isUndo(@Nullable Boolean bool) {
            this.isUndo = bool;
            return this;
        }

        public com.tinder.recs.data.RatingRequestFactory.RatingRequestCommonFields.Builder placeId(@Nullable String str) {
            this.placeId = str;
            return this;
        }

        public com.tinder.recs.data.RatingRequestFactory.RatingRequestCommonFields.Builder sNumber(@Nullable Long l) {
            this.sNumber = l;
            return this;
        }

        public RatingRequestCommonFields build() {
            String str = "";
            if (this.recId == null) {
            ...
            if (str.isEmpty()) {
                return new AutoValue_RatingRequestFactory_RatingRequestCommonFields(r0.recId, r0.photoId, r0.contentHash, r0.didRecUserSuperlike, r0.wasRecUserPassporting, r0.isCurrentUserPassporting, r0.isCurrentUserBoosting, r0.isFastMatch, r0.isTopPicks, r0.isUndo, r0.placeId, r0.sNumber);
            }
    ...
    private AutoValue_RatingRequestFactory_RatingRequestCommonFields(String str, @Nullable String str2, @Nullable String str3, @Nullable Boolean bool, @Nullable Boolean bool2, @Nullable Boolean bool3, @Nullable Boolean bool4, @Nullable Boolean bool5, @Nullable Boolean bool6, @Nullable Boolean bool7, @Nullable String str4, @Nullable Long l) {
        this.recId = str;
        this.photoId = str2;
    ...
    public String toString() {
        StringBuilder stringBuilder = new StringBuilder();
        stringBuilder.append("RatingRequestCommonFields{recId=");
    ...
    L_0x0003:
        return r0;
    L_0x0004:
        r1 = r5 instanceof com.tinder.recs.data.RatingRequestFactory.RatingRequestCommonFields;
        r2 = 0;
        if (r1 == 0) goto L_0x0117;
    L_0x0009:
        r5 = (com.tinder.recs.data.RatingRequestFactory.RatingRequestCommonFields) r5;
        r1 = r4.recId;
        r3 = r5.recId();
        r1 = r1.equals(r3);
    ...
    L_0x0117:
        return r2;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.tinder.recs.data.AutoValue_RatingRequestFactory_RatingRequestCommonFields.equals(java.lang.Object):boolean");
    }

    public int hashCode() {
        int i = 0;
        int hashCode = (((((((((((((((((((((this.recId.hashCode() ^ 1000003) * 1000003) ^ (this.photoId == null ? 0 : this.photoId.hashCode())) * 1000003) ^ (this.contentHash == null ? 0 : this.contentHash.hashCode())) * 1000003) ^ (this.didRecUserSuperlike == null ? 0 : this.didRecUserSuperlike.hashCode())) * 1000003) ^ (this.wasRecUserPassporting == null ? 0 : this.wasRecUserPassporting.hashCode())) * 1000003) ^ (this.isCurrentUserPassporting == null ? 0 : this.isCurrentUserPassporting.hashCode())) * 1000003) ^ (this.isCurrentUserBoosting == null ? 0 : this.isCurrentUserBoosting.hashCode())) * 1000003) ^ (this.isFastMatch == null ? 0 : this.isFastMatch.hashCode())) * 1000003) ^ (this.isTopPicks == null ? 0 : this.isTopPicks.hashCode())) * 1000003) ^ (this.isUndo == null ? 0 : this.isUndo.hashCode())) * 1000003) ^ (this.placeId == null ? 0 : this.placeId.hashCode())) * 1000003;
