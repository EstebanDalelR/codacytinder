...
final class TappyLoopsCarouselView$tapRegionDetector$1 extends FunctionReference implements Function1<TapRegion, C15813i> {
    TappyLoopsCarouselView$tapRegionDetector$1(TappyLoopsCarouselView tappyLoopsCarouselView) {
        super(1, tappyLoopsCarouselView);
    }
    ...
    public final KDeclarationContainer getOwner() {
        return C15825i.m59860a(TappyLoopsCarouselView.class);
    }
    ...
    public final void invoke(@NotNull TapRegion tapRegion) {
        ...
        ((TappyLoopsCarouselView) this.receiver).dispatchTapRegionEvent(tapRegion);
    }
}
