...
/* renamed from: com.tinder.reactions.gestures.animators.a */
public final class C16335a extends C14646c {
    @Inject
    @NotNull
    /* renamed from: a */
    public C16280l f50827a;
    @Inject
    @NotNull
    /* renamed from: b */
    ...
    /* renamed from: com.tinder.reactions.gestures.animators.a$2 */
    static final class C187262<T> implements Action1<Throwable> {
        /* renamed from: a */
        public static final C187262 f58212a = new C187262();

        C187262() {
        }

        public /* synthetic */ void call(Object obj) {
            m67150a((Throwable) obj);
        }

        /* renamed from: a */
        public final void m67150a(Throwable th) {
            C0001a.c(th);
        }
    }

    public C16335a(@NotNull final FlingOnTargetGrandGestureView flingOnTargetGrandGestureView, @NotNull final C16365n c16365n, @NotNull C14641a c14641a) {
        C2668g.b(flingOnTargetGrandGestureView, "view");
        C2668g.b(c16365n, "viewModel");
        C2668g.b(c14641a, "mediator");
        View view = flingOnTargetGrandGestureView;
        super(view, c16365n, c14641a);
        Context context = flingOnTargetGrandGestureView.getContext();
        C2668g.a(context, "view.context");
        m61629a(context);
        C14673e.m55916a(flingOnTargetGrandGestureView, c16365n);
        flingOnTargetGrandGestureView.getGrandGestureStateObservable().j(C14612a.f46118a.m55756a(view)).a(new Action1<State>() {
            public /* synthetic */ void call(Object obj) {
                m67149a((State) obj);
            }

            /* renamed from: a */
            public final void m67149a(State state) {
                if (state == State.GESTURE_INCORRECT_INTERACTION) {
                    flingOnTargetGrandGestureView.m61692a();
                    this.m61631b();
                } else if (state == State.GESTURE_ACTIVATED) {
                    this.m55839a(c16365n.m61725a());
                }
            }
        }, (Action1) C187262.f58212a);
    }

    /* renamed from: b */
    private final void m61631b() {
        C16280l c16280l = this.f50827a;
        if (c16280l == null) {
    ...
    /* renamed from: a */
    private final void m61629a(Context context) {
