...
public final class AutoPlayLoopsOptionsActivity$$special$$inlined$bindView$1 extends Lambda implements Function0<Toolbar> {
    /* renamed from: a */
    final /* synthetic */ Activity f58402a;
    /* renamed from: b */
    final /* synthetic */ int f58403b;

    public AutoPlayLoopsOptionsActivity$$special$$inlined$bindView$1(Activity activity, int i) {
    ...
    @NotNull
    /* renamed from: a */
    public final Toolbar m67297a() {
        View findViewById = this.f58402a.findViewById(this.f58403b);
        ...
        stringBuilder.append(this.f58403b);
