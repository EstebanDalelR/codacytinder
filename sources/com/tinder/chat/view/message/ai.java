...
public final class ai extends RelativeLayout implements BindableChatItemView<C12747i> {
    ...
    @NotNull
    /* renamed from: b */
    public C8490z f34501b;
    @Inject
    @NotNull
    /* renamed from: c */
    public C8458c f34502c;
    @Inject
    @NotNull
    /* renamed from: d */
    public ac f34503d;
    /* renamed from: e */
    private final float f34504e = au.a(this, R.dimen.text_s);
    @DrawableRes
    /* renamed from: f */
    private final int f34505f = R.drawable.chat_message_outbound_bubble_background_batch_start;
    @NotNull
    /* renamed from: g */
    private final TextView f34506g;
    @NotNull
    /* renamed from: h */
    private final TextView f34507h;
    @NotNull
    /* renamed from: i */
    private final FeedImageContentView f34508i;
    /* renamed from: j */
    private HashMap f34509j;

    /* renamed from: a */
    public View m42728a(int i) {
        if (this.f34509j == null) {
            this.f34509j = new HashMap();
        }
        View view = (View) this.f34509j.get(Integer.valueOf(i));
        if (view != null) {
            return view;
        }
        view = findViewById(i);
        this.f34509j.put(Integer.valueOf(i), view);
        return view;
    }
    ...
    public ai(@NotNull Context context) {
        ...
        TextView textView = (TextView) m42728a(C6248a.chatTextMessageContent);
        C2668g.a(textView, "chatTextMessageContent");
        this.f34506g = textView;
        textView = (TextView) m42728a(C6248a.chatMessageTimestamp);
        C2668g.a(textView, "chatMessageTimestamp");
        this.f34507h = textView;
        FeedImageContentView feedImageContentView = (FeedImageContentView) m42728a(C6248a.chatActivityFeedImageContainer);
        C2668g.a(feedImageContentView, "chatActivityFeedImageContainer");
        this.f34508i = feedImageContentView;
    }

    public /* synthetic */ void bind(ChatItem chatItem) {
        m42729a((C12747i) chatItem);
    }

    @NotNull
    public final ae getMessageActionHandler$Tinder_release() {
        ae aeVar = this.f34500a;
        if (aeVar == null) {
    ...
    /* renamed from: a */
    public void m42729a(@NotNull C12747i c12747i) {
        C2668g.b(c12747i, "viewModel");
        ae aeVar = this.f34500a;
        if (aeVar == null) {
            C2668g.b("messageActionHandler");
        }
        ad.m36270a(this, c12747i, aeVar);
        C8490z c8490z = this.f34501b;
        if (c8490z == null) {
            C2668g.b("timestampFormatter");
        }
        ah.m36313a(this, c12747i, c8490z);
        C8458c c8458c = this.f34502c;
        if (c8458c == null) {
            C2668g.b("imageClickHandler");
        }
        ...
        ac.m36250a(this, c12747i, c8458c, acVar);
    }
}
