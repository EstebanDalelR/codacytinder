...
public final class C10608c extends RelativeLayout implements BindableChatItemView<C12747i> {
    ...
    public C10608c(@NotNull Context context) {
        ...
        TextView textView = (TextView) m42820a(C6248a.chatTextMessageContent);
        C2668g.a(textView, "chatTextMessageContent");
        this.f34687g = textView;
        ChatAvatarView chatAvatarView = (ChatAvatarView) m42820a(C6248a.chatMessageAvatar);
        C2668g.a(chatAvatarView, "chatMessageAvatar");
        this.f34688h = chatAvatarView;
        textView = (TextView) m42820a(C6248a.chatMessageTimestamp);
        C2668g.a(textView, "chatMessageTimestamp");
        this.f34689i = textView;
        FeedImageContentView feedImageContentView = (FeedImageContentView) m42820a(C6248a.chatActivityFeedImageContainer);
        C2668g.a(feedImageContentView, "chatActivityFeedImageContainer");
        this.f34690j = feedImageContentView;
    }

    public /* synthetic */ void bind(ChatItem chatItem) {
        m42821a((C12747i) chatItem);
    }

    @NotNull
    public final C10588n getMessageActionHandler$Tinder_release() {
        C10588n c10588n = this.f34681a;
        if (c10588n == null) {
    ...
    /* renamed from: a */
    public void m42821a(@NotNull C12747i c12747i) {
        C2668g.b(c12747i, "viewModel");
        C10588n c10588n = this.f34681a;
        if (c10588n == null) {
            C2668g.b("messageActionHandler");
        }
        ad.m36280a(this, c12747i, c10588n);
        c10588n = this.f34681a;
        if (c10588n == null) {
            C2668g.b("messageActionHandler");
        }
        aa.m36234a(this, c12747i, (MessageAvatarClickingActionHandler) c10588n);
        C8490z c8490z = this.f34682b;
        if (c8490z == null) {
            C2668g.b("timestampFormatter");
        }
        ah.m36324a(this, c12747i, c8490z);
        C8458c c8458c = this.f34683c;
        if (c8458c == null) {
            C2668g.b("imageClickHandler");
        }
        ...
        ac.m36257a(this, c12747i, c8458c, c10587l);
    }
}
