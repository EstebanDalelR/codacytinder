...
public final class au extends RelativeLayout implements BindableChatItemView<C12747i> {
    ...
    @NotNull
    /* renamed from: b */
    public C8490z f34595b;
    @Inject
    @NotNull
    /* renamed from: c */
    public C8458c f34596c;
    @Inject
    @NotNull
    /* renamed from: d */
    public ac f34597d;
    /* renamed from: e */
    private final float f34598e = com.tinder.utils.au.a(this, R.dimen.text_s);
    @DrawableRes
    /* renamed from: f */
    private final int f34599f = R.drawable.chat_message_outbound_bubble_background_batch_start;
    @NotNull
    /* renamed from: g */
    private final TextView f34600g;
    @NotNull
    /* renamed from: h */
    private final TextView f34601h;
    @NotNull
    /* renamed from: i */
    private final FeedProfileChangeBioContentView f34602i;
    /* renamed from: j */
    private HashMap f34603j;

    /* renamed from: a */
    public View m42771a(int i) {
        if (this.f34603j == null) {
            this.f34603j = new HashMap();
        }
        View view = (View) this.f34603j.get(Integer.valueOf(i));
        if (view != null) {
            return view;
        }
        view = findViewById(i);
        this.f34603j.put(Integer.valueOf(i), view);
        return view;
    }

    public au(@NotNull Context context) {
        ...
        RelativeLayout.inflate(context, R.layout.chat_activity_feed_outbound_change_bio_view, this);
        setLayoutParams(new LayoutParams(-1, -2));
        TextView textView = (TextView) m42771a(C6248a.chatTextMessageContent);
        C2668g.a(textView, "chatTextMessageContent");
        this.f34600g = textView;
        textView = (TextView) m42771a(C6248a.chatMessageTimestamp);
        C2668g.a(textView, "chatMessageTimestamp");
        this.f34601h = textView;
        FeedProfileChangeBioContentView feedProfileChangeBioContentView = (FeedProfileChangeBioContentView) m42771a(C6248a.chatActivityFeedImageContainer);
        C2668g.a(feedProfileChangeBioContentView, "chatActivityFeedImageContainer");
        this.f34602i = feedProfileChangeBioContentView;
    }

    public /* synthetic */ void bind(ChatItem chatItem) {
        m42772a((C12747i) chatItem);
    }

    @NotNull
    public final ae getMessageActionHandler$Tinder_release() {
        ae aeVar = this.f34594a;
        if (aeVar == null) {
    ...
    /* renamed from: a */
    public void m42772a(@NotNull C12747i c12747i) {
        C2668g.b(c12747i, "viewModel");
        ae aeVar = this.f34594a;
        if (aeVar == null) {
            C2668g.b("messageActionHandler");
        }
        ad.m36276a(this, c12747i, aeVar);
        C8490z c8490z = this.f34595b;
        if (c8490z == null) {
            C2668g.b("timestampFormatter");
        }
        ah.m36319a(this, c12747i, c8490z);
        C8458c c8458c = this.f34596c;
        if (c8458c == null) {
            C2668g.b("imageClickHandler");
        }
        ...
        ac.m36254a(this, c12747i, c8458c, acVar);
        c12747i = c12747i.m50169a();
        if (c12747i instanceof com.tinder.chat.view.model.ac) {
            FeedProfileChangeBioContentView.m50250a(this.f34602i, ((com.tinder.chat.view.model.ac) c12747i).m42918c(), null, null, 6, null);
        } else {
            c12747i = new IllegalArgumentException("OutboundFeedProfileChangeBioView accepts only ProfileChangeBioViewModel");
        }
    }
}
