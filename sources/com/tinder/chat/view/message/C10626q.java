...
@Metadata(bv = {1, 0, 2}, d1 = {"\u0000j\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0010\b\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0005\n\u0002\u0018\u0002\n\u0002\b\u0005\n\u0002\u0018\u0002\n\u0002\b\u0005\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0010\u0007\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0007\n\u0002\u0010\u0002\n\u0002\b\u0002\u0018\u00002\u00020\u00012\b\u0012\u0004\u0012\u00020\u00030\u0002B\r\u0012\u0006\u0010\u0004\u001a\u00020\u0005¢\u0006\u0002\u0010\u0006J\u0010\u00105\u001a\u0002062\u0006\u00107\u001a\u00020\u0003H\u0016R\u0014\u0010\u0007\u001a\u00020\bX\u0004¢\u0006\b\n\u0000\u001a\u0004\b\t\u0010\nR\u0016\u0010\u000b\u001a\u00020\f8\u0000XD¢\u0006\b\n\u0000\u001a\u0004\b\r\u0010\u000eR\u0014\u0010\u000f\u001a\u00020\u0010X\u0004¢\u0006\b\n\u0000\u001a\u0004\b\u0011\u0010\u0012R\u001e\u0010\u0013\u001a\u00020\u00148\u0000@\u0000X.¢\u0006\u000e\n\u0000\u001a\u0004\b\u0015\u0010\u0016\"\u0004\b\u0017\u0010\u0018R\u001e\u0010\u0019\u001a\u00020\u001a8\u0000@\u0000X.¢\u0006\u000e\n\u0000\u001a\u0004\b\u001b\u0010\u001c\"\u0004\b\u001d\u0010\u001eR\u001e\u0010\u001f\u001a\u00020 8\u0000@\u0000X.¢\u0006\u000e\n\u0000\u001a\u0004\b!\u0010\"\"\u0004\b#\u0010$R\u0014\u0010%\u001a\u00020&X\u0004¢\u0006\b\n\u0000\u001a\u0004\b'\u0010(R\u0014\u0010)\u001a\u00020*X\u0004¢\u0006\b\n\u0000\u001a\u0004\b+\u0010,R\u001e\u0010-\u001a\u00020.8\u0000@\u0000X.¢\u0006\u000e\n\u0000\u001a\u0004\b/\u00100\"\u0004\b1\u00102R\u0014\u00103\u001a\u00020&X\u0004¢\u0006\b\n\u0000\u001a\u0004\b4\u0010(¨\u00068"}, d2 = {"Lcom/tinder/chat/view/message/InboundFeedProfileChangeWorkView;", "Landroid/widget/RelativeLayout;", "Lcom/tinder/chat/view/message/BindableChatItemView;", "Lcom/tinder/chat/view/model/ActivityMessageViewModel;", "context", "Landroid/content/Context;", "(Landroid/content/Context;)V", "avatarView", "Lcom/tinder/chat/view/ChatAvatarView;", "getAvatarView$Tinder_release", "()Lcom/tinder/chat/view/ChatAvatarView;", "bubbleDrawableId", "", "getBubbleDrawableId$Tinder_release", "()I", "feedProfileChangeWorkContentView", "Lcom/tinder/common/feed/view/FeedProfileChangeWorkContentView;", "getFeedProfileChangeWorkContentView$Tinder_release", "()Lcom/tinder/common/feed/view/FeedProfileChangeWorkContentView;", "imageClickHandler", "Lcom/tinder/chat/view/action/ActivityMessageImageClickHandler;", "getImageClickHandler$Tinder_release", "()Lcom/tinder/chat/view/action/ActivityMessageImageClickHandler;", "setImageClickHandler$Tinder_release", "(Lcom/tinder/chat/view/action/ActivityMessageImageClickHandler;)V", "mediaUnavailableHandler", "Lcom/tinder/chat/view/action/InboundActivityMessageMediaUnavailableHandler;", "getMediaUnavailableHandler$Tinder_release", "()Lcom/tinder/chat/view/action/InboundActivityMessageMediaUnavailableHandler;", "setMediaUnavailableHandler$Tinder_release", "(Lcom/tinder/chat/view/action/InboundActivityMessageMediaUnavailableHandler;)V", "messageActionHandler", "Lcom/tinder/chat/view/action/InboundActivityMessageViewActionHandler;", "getMessageActionHandler$Tinder_release", "()Lcom/tinder/chat/view/action/InboundActivityMessageViewActionHandler;", "setMessageActionHandler$Tinder_release", "(Lcom/tinder/chat/view/action/InboundActivityMessageViewActionHandler;)V", "textMessageContentView", "Landroid/widget/TextView;", "getTextMessageContentView$Tinder_release", "()Landroid/widget/TextView;", "textSize", "", "getTextSize$Tinder_release", "()F", "timestampFormatter", "Lcom/tinder/chat/view/message/MessageTimestampFormatter;", "getTimestampFormatter$Tinder_release", "()Lcom/tinder/chat/view/message/MessageTimestampFormatter;", "setTimestampFormatter$Tinder_release", "(Lcom/tinder/chat/view/message/MessageTimestampFormatter;)V", "timestampView", "getTimestampView$Tinder_release", "bind", "", "viewModel", "Tinder_release"}, k = 1, mv = {1, 1, 10})
/* renamed from: com.tinder.chat.view.message.q */
public final class C10626q extends RelativeLayout implements BindableChatItemView<C12747i> {
    @Inject
    @NotNull
    /* renamed from: a */
    public C10588n f34796a;
    @Inject
    @NotNull
    /* renamed from: b */
    public C8490z f34797b;
    @Inject
    @NotNull
    /* renamed from: c */
    public C8458c f34798c;
    @Inject
    @NotNull
    /* renamed from: d */
    public C10587l f34799d;
    /* renamed from: e */
    private final float f34800e = au.a(this, R.dimen.text_s);
    @DrawableRes
    /* renamed from: f */
    private final int f34801f = R.drawable.chat_activity_feed_message_inbound_bubble_background;
    @NotNull
    /* renamed from: g */
    private final TextView f34802g;
    @NotNull
    /* renamed from: h */
    private final ChatAvatarView f34803h;
    @NotNull
    /* renamed from: i */
    private final TextView f34804i;
    @NotNull
    /* renamed from: j */
    private final FeedProfileChangeWorkContentView f34805j;
    /* renamed from: k */
    private HashMap f34806k;

    /* renamed from: a */
    public View m42870a(int i) {
        if (this.f34806k == null) {
            this.f34806k = new HashMap();
        }
        View view = (View) this.f34806k.get(Integer.valueOf(i));
        if (view != null) {
            return view;
        }
        view = findViewById(i);
        this.f34806k.put(Integer.valueOf(i), view);
        return view;
    }

    public C10626q(@NotNull Context context) {
        ...
        RelativeLayout.inflate(context, R.layout.chat_activity_feed_inbound_change_work_view, this);
        setLayoutParams(new LayoutParams(-1, -2));
        TextView textView = (TextView) m42870a(C6248a.chatTextMessageContent);
        C2668g.a(textView, "chatTextMessageContent");
        this.f34802g = textView;
        ChatAvatarView chatAvatarView = (ChatAvatarView) m42870a(C6248a.chatMessageAvatar);
        C2668g.a(chatAvatarView, "chatMessageAvatar");
        this.f34803h = chatAvatarView;
        textView = (TextView) m42870a(C6248a.chatMessageTimestamp);
        C2668g.a(textView, "chatMessageTimestamp");
        this.f34804i = textView;
        FeedProfileChangeWorkContentView feedProfileChangeWorkContentView = (FeedProfileChangeWorkContentView) m42870a(C6248a.chatActivityFeedImageContainer);
        C2668g.a(feedProfileChangeWorkContentView, "chatActivityFeedImageContainer");
        this.f34805j = feedProfileChangeWorkContentView;
    }

    public /* synthetic */ void bind(ChatItem chatItem) {
        m42871a((C12747i) chatItem);
    }

    @NotNull
    public final C10588n getMessageActionHandler$Tinder_release() {
        C10588n c10588n = this.f34796a;
        if (c10588n == null) {
    ...
    /* renamed from: a */
    public void m42871a(@NotNull C12747i c12747i) {
        C2668g.b(c12747i, "viewModel");
        C10588n c10588n = this.f34796a;
        if (c10588n == null) {
            C2668g.b("messageActionHandler");
        }
        ad.m36287a(this, c12747i, c10588n);
        c10588n = this.f34796a;
        if (c10588n == null) {
            C2668g.b("messageActionHandler");
        }
        aa.m36241a(this, c12747i, (MessageAvatarClickingActionHandler) c10588n);
        C8490z c8490z = this.f34797b;
        if (c8490z == null) {
            C2668g.b("timestampFormatter");
        }
        ah.m36331a(this, c12747i, c8490z);
        C8458c c8458c = this.f34798c;
        if (c8458c == null) {
            C2668g.b("imageClickHandler");
        }
        ...
        ac.m36262a(this, c12747i, c8458c, c10587l);
        c12747i = c12747i.m50169a();
        if (c12747i instanceof ae) {
            FeedProfileChangeWorkContentView.m50258a(this.f34805j, ((C8493c) C19301m.f(((ae) c12747i).m42926c())).m36354a(), null, null, 6, null);
            return;
        }
        throw ((Throwable) new IllegalArgumentException("InboundFeedProfileChangeWorkView accepts only ProfileChangeWorkViewModel"));
    }
}
