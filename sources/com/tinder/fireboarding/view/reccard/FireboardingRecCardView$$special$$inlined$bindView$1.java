...
public final class FireboardingRecCardView$$special$$inlined$bindView$1 extends Lambda implements Function0<View> {
    /* renamed from: a */
    final /* synthetic */ View f44441a;
    /* renamed from: b */
    final /* synthetic */ int f44442b;

    public FireboardingRecCardView$$special$$inlined$bindView$1(View view, int i) {
        this.f44441a = view;
        this.f44442b = i;
        super(0);
    }
    ...
    @NotNull
    /* renamed from: a */
    public final View m53689a() {
        View findViewById = this.f44441a.findViewById(this.f44442b);
        ...
        stringBuilder.append(this.f44442b);
