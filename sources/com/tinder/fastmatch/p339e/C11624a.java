package com.tinder.fastmatch.p339e;
...
/* renamed from: com.tinder.fastmatch.e.a */
public final class C11624a implements SwipeProcessingRulesResolver {
    /* renamed from: a */
    private final Lazy<SwipeDispatchRule> f38047a;
    /* renamed from: b */
    private final Lazy<DupesPreventionRule> f38048b;
    /* renamed from: c */
    private final Lazy<UserRecSwipeAnalyticsRule> f38049c;

    public C11624a(@NotNull Lazy<SwipeDispatchRule> lazy, @NotNull Lazy<DupesPreventionRule> lazy2, @NotNull Lazy<UserRecSwipeAnalyticsRule> lazy3) {
    ...
    public SwipeProcessingRulesChain resolveSwipeRules(@NotNull Swipe swipe) {
        ...
        if (swipe.getType() == RecType.USER) {
            ...
            swipe = this.f38047a.get();
            C2668g.a(swipe, "swipeDispatchRule.get()");
            swipeProcessingRulesChain.addPostSwipeConsumptionRule((PostSwipeConsumptionRule) swipe);
            swipe = this.f38048b.get();
