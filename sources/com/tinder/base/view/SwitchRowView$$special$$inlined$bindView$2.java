...
public final class SwitchRowView$$special$$inlined$bindView$2 extends Lambda implements Function0<TextView> {
    /* renamed from: a */
    final /* synthetic */ View f43453a;
    /* renamed from: b */
    final /* synthetic */ int f43454b;

    public SwitchRowView$$special$$inlined$bindView$2(View view, int i) {
        this.f43453a = view;
        this.f43454b = i;
        super(0);
    }
    ...
    @NotNull
    /* renamed from: a */
    public final TextView m53165a() {
        View findViewById = this.f43453a.findViewById(this.f43454b);
        ...
        stringBuilder.append(this.f43454b);
