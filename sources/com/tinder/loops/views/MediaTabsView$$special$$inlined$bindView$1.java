...
public final class MediaTabsView$$special$$inlined$bindView$1 extends Lambda implements Function0<TabLayout> {
    /* renamed from: a */
    final /* synthetic */ View f44547a;
    /* renamed from: b */
    final /* synthetic */ int f44548b;

    public MediaTabsView$$special$$inlined$bindView$1(View view, int i) {
        this.f44547a = view;
        this.f44548b = i;
        super(0);
    }
    ...
    @NotNull
    /* renamed from: a */
    public final TabLayout m53785a() {
        View findViewById = this.f44547a.findViewById(this.f44548b);
        ...
        stringBuilder.append(this.f44548b);
