...
public final class TopPicksV2NetworkPerfInspector implements NetworkPerfInspector {
    private final PerfEventUrlUtils perfEventUrlUtils;

    @Inject
    public TopPicksV2NetworkPerfInspector(@NotNull PerfEventUrlUtils perfEventUrlUtils) {
    ...
    public NetworkPerfEvent inspect(@NotNull NetworkPerfEventDataModel networkPerfEventDataModel, @NotNull C9064a c9064a) {
        ...
        if (urlPathSegments.size() < 2 || !C2668g.a((String) urlPathSegments.get(0), "v2") || !C2668g.a((String) urlPathSegments.get(1), "top-picks")) {
