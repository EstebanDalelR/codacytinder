...
public final class PurchaseNetworkPerfInspector implements NetworkPerfInspector {
    ...
    public NetworkPerfEvent inspect(@NotNull NetworkPerfEventDataModel networkPerfEventDataModel, @NotNull C9064a c9064a) {
        ...
        if ((urlPathSegments.isEmpty() ^ 1) == 0 || !C2668g.a((String) C19301m.f(urlPathSegments), "purchase")) {
