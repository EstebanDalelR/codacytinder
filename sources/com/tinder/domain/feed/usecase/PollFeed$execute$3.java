...
final class PollFeed$execute$3<T, R> implements Func1<Observable<? extends Void>, Observable<?>> {
    final /* synthetic */ PollFeed this$0;

    PollFeed$execute$3(PollFeed pollFeed) {
        this.this$0 = pollFeed;
    }
