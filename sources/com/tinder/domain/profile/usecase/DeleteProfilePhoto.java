...
@Metadata(bv = {1, 0, 2}, d1 = {"\u0000\u001e\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\u0018\u00002\b\u0012\u0004\u0012\u00020\u00020\u0001B\u000f\b\u0007\u0012\u0006\u0010\u0003\u001a\u00020\u0004¢\u0006\u0002\u0010\u0005J\u0010\u0010\u0006\u001a\u00020\u00072\u0006\u0010\b\u001a\u00020\u0002H\u0016R\u000e\u0010\u0003\u001a\u00020\u0004X\u0004¢\u0006\u0002\n\u0000¨\u0006\t"}, d2 = {"Lcom/tinder/domain/profile/usecase/DeleteProfilePhoto;", "Lcom/tinder/domain/common/reactivex/usecase/CompletableUseCase;", "Lcom/tinder/domain/profile/model/ProfilePhoto;", "profilePhotoRepository", "Lcom/tinder/domain/profile/repository/ProfilePhotoRepository;", "(Lcom/tinder/domain/profile/repository/ProfilePhotoRepository;)V", "execute", "Lio/reactivex/Completable;", "request", "domain_release"}, k = 1, mv = {1, 1, 10})
public final class DeleteProfilePhoto implements CompletableUseCase<ProfilePhoto> {
    private final ProfilePhotoRepository profilePhotoRepository;

    @Inject
    public DeleteProfilePhoto(@NotNull ProfilePhotoRepository profilePhotoRepository) {
        C2668g.b(profilePhotoRepository, "profilePhotoRepository");
        this.profilePhotoRepository = profilePhotoRepository;
    }

    @NotNull
    public C3956a execute(@NotNull ProfilePhoto profilePhoto) {
        C2668g.b(profilePhoto, "request");
        return this.profilePhotoRepository.delete(profilePhoto);
    }
}
