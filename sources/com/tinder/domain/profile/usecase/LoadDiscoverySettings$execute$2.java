...
final class LoadDiscoverySettings$execute$2<T, R> implements Function<T, R> {
    public static final LoadDiscoverySettings$execute$2 INSTANCE = new LoadDiscoverySettings$execute$2();

    LoadDiscoverySettings$execute$2() {
    }
