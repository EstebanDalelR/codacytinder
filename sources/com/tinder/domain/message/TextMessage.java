...
public final class TextMessage extends Message {
    ...
    @JvmOverloads
    public TextMessage(@NotNull String str, @NotNull String str2, @NotNull String str3, @NotNull String str4, @NotNull String str5, @NotNull DateTime dateTime, boolean z, boolean z2, @NotNull DeliveryStatus deliveryStatus) {
        this(null, str, str2, str3, str4, str5, dateTime, z, z2, deliveryStatus, 1, null);
    }

    @NotNull
    public static /* synthetic */ TextMessage copy$default(TextMessage textMessage, Long l, String str, String str2, String str3, String str4, String str5, DateTime dateTime, boolean z, boolean z2, DeliveryStatus deliveryStatus, int i, Object obj) {
        int i2 = i;
        return textMessage.copy((i2 & 1) != 0 ? textMessage.getClientSequentialId() : l, (i2 & 2) != 0 ? textMessage.getId() : str, (i2 & 4) != 0 ? textMessage.getMatchId() : str2, (i2 & 8) != 0 ? textMessage.getToId() : str3, (i2 & 16) != 0 ? textMessage.getFromId() : str4, (i2 & 32) != 0 ? textMessage.getText() : str5, (i2 & 64) != 0 ? textMessage.getSentDate() : dateTime, (i2 & ProfileEditingConfig.DEFAULT_MAX_LENGTH) != 0 ? textMessage.isLiked() : z, (i2 & 256) != 0 ? textMessage.isSeen() : z2, (i2 & 512) != 0 ? textMessage.getDeliveryStatus() : deliveryStatus);
    }
    ...
    @NotNull
    public final TextMessage copy(@Nullable Long l, @NotNull String str, @NotNull String str2, @NotNull String str3, @NotNull String str4, @NotNull String str5, @NotNull DateTime dateTime, boolean z, boolean z2, @NotNull DeliveryStatus deliveryStatus) {
        String str6 = str;
        C2668g.b(str6, "id");
        String str7 = str2;
        ...
        return new TextMessage(l, str6, str7, str8, str9, str10, dateTime2, z, z2, deliveryStatus2);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof TextMessage) {
            ...
            if (C2668g.a(getClientSequentialId(), textMessage.getClientSequentialId()) && C2668g.a(getId(), textMessage.getId()) && C2668g.a(getMatchId(), textMessage.getMatchId()) && C2668g.a(getToId(), textMessage.getToId()) && C2668g.a(getFromId(), textMessage.getFromId()) && C2668g.a(getText(), textMessage.getText()) && C2668g.a(getSentDate(), textMessage.getSentDate())) {
                if ((isLiked() == textMessage.isLiked() ? 1 : null) != null) {
                    return (isSeen() == textMessage.isSeen() ? 1 : null) != null && C2668g.a(getDeliveryStatus(), textMessage.getDeliveryStatus());
                }
            }
        }
    }
    ...
    public String toString() {
        ...
        stringBuilder.append("TextMessage(clientSequentialId=");
    ...
    @JvmOverloads
    public /* synthetic */ TextMessage(Long l, String str, String str2, String str3, String str4, String str5, DateTime dateTime, boolean z, boolean z2, DeliveryStatus deliveryStatus, int i, C15823e c15823e) {
    ...
    @JvmOverloads
    public TextMessage(@Nullable Long l, @NotNull String str, @NotNull String str2, @NotNull String str3, @NotNull String str4, @NotNull String str5, @NotNull DateTime dateTime, boolean z, boolean z2, @NotNull DeliveryStatus deliveryStatus) {
        C2668g.b(str, "id");
