...
public final class UnregisterPushToken implements CompletableUseCase<String> {
    ...
    public Completable execute(@NotNull String str) {
        ...
        return this.tokenRepository.unregisterToken(str);
    }
}
