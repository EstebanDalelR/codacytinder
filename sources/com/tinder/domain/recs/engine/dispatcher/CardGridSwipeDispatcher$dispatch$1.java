...
final class CardGridSwipeDispatcher$dispatch$1<T> implements Action1<Ended> {
    public static final CardGridSwipeDispatcher$dispatch$1 INSTANCE = new CardGridSwipeDispatcher$dispatch$1();

    CardGridSwipeDispatcher$dispatch$1() {
    }
