...
final class CardGridRecsLoader$RecsLoadingRefreshingCoordinator$resetRecs$3<T> implements Action1<Throwable> {
    final /* synthetic */ RecsLoadingRefreshingCoordinator this$0;

    CardGridRecsLoader$RecsLoadingRefreshingCoordinator$resetRecs$3(RecsLoadingRefreshingCoordinator recsLoadingRefreshingCoordinator) {
        this.this$0 = recsLoadingRefreshingCoordinator;
    }

    public final void call(Throwable th) {
        StringBuilder stringBuilder = new StringBuilder();
        stringBuilder.append("Unable to reset ");
