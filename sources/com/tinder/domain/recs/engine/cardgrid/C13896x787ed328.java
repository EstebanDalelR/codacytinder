...
/* renamed from: com.tinder.domain.recs.engine.cardgrid.CardGridRecsLoader$RecsLoadingRefreshingCoordinator$loadMoreRecs$2 */
final class C13896x787ed328<T> implements Action1<C8786k> {
    final /* synthetic */ RecsLoadingRefreshingCoordinator this$0;

    C13896x787ed328(RecsLoadingRefreshingCoordinator recsLoadingRefreshingCoordinator) {
        this.this$0 = recsLoadingRefreshingCoordinator;
    }

    public final void call(C8786k c8786k) {
        synchronized (this.this$0) {
            Subscription access$getLoadRecsSubscription$p = this.this$0.loadRecsSubscription;
            if (access$getLoadRecsSubscription$p != null) {
                access$getLoadRecsSubscription$p.unsubscribe();
            }
