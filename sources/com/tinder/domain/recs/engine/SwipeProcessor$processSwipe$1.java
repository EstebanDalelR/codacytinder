...
final class SwipeProcessor$processSwipe$1<T, R> implements Func1<T, Single<? extends R>> {
    final /* synthetic */ SwipeProcessor this$0;

    SwipeProcessor$processSwipe$1(SwipeProcessor swipeProcessor) {
    ...
    public final Single<Swipe> call(Swipe swipe) {
        ...
        C2668g.a(swipe, "it");
        return swipeProcessor.consumeSwipe(swipe);
    }
}
