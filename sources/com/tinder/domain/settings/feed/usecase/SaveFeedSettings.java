...
public final class SaveFeedSettings implements VoidUseCase<FeedSettings> {
    ...
    public void execute(@NotNull FeedSettings feedSettings) {
        C2668g.b(feedSettings, "request");
        this.profileRemoteRepository.update(new FeedSettingsUpdateRequest(feedSettings)).b(C15756a.b()).a(SaveFeedSettings$execute$1.INSTANCE, new SaveFeedSettings$sam$io_reactivex_functions_Consumer$0(new SaveFeedSettings$execute$2(this.logger)));
    }
}
