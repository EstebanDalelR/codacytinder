...
class BackgroundManager {
    ...
    public void onActivityPaused() {
        if (this.flushOnBackground && !this.inBackground) {
            ...
            try {
                this.backgroundFutureRef.compareAndSet(null, this.executorService.schedule(new C10811(), 5000, TimeUnit.MILLISECONDS));
            } catch (Throwable e) {
                C15608c.h().d(Answers.TAG, "Failed to schedule background detector", e);
            }
        }
    }
}
