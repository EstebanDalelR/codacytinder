...
public class C1441o {
    /* renamed from: a */
    private static String m5047a(byte[] bArr, String str) {
    ...
    /* renamed from: a */
    public static void m5048a(HttpsURLConnection httpsURLConnection, Set<String> set, Set<String> set2) {
        if (VERSION.SDK_INT != 15 || !"4.0.3".equals(VERSION.RELEASE)) {
            try {
                ...
                while (i < length) {
                    ...
                    String a = C1441o.m5047a(x509Certificate.getEncoded(), "SHA-1");
                    if (set == null || !set.contains(a)) {
                        String a2 = C1441o.m5047a(x509Certificate.getPublicKey().getEncoded(), "SHA-1");
