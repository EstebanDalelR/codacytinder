...
abstract class LoginMethodHandler implements Parcelable {
    ...
    LoginMethodHandler(Parcel parcel) {
        this.methodLoggingExtras = Utility.m5769a(parcel);
    }
    ...
    protected void logWebLoginCompleted(String str) {
        ...
        AppEventsLogger b = AppEventsLogger.m5528b(this.loginClient.getActivity(), applicationId);
        Bundle bundle = new Bundle();
        bundle.putString("fb_web_login_e2e", str);
        bundle.putLong("fb_web_login_switchback_time", System.currentTimeMillis());
        bundle.putString("app_id", applicationId);
        b.logSdkEvent("fb_dialogs_web_login_dialog_complete", null, bundle);
    }

    static AccessToken createAccessTokenFromNativeLogin(Bundle bundle, AccessTokenSource accessTokenSource, String str) {
        Date a = Utility.m5766a(bundle, "com.facebook.platform.extra.EXPIRES_SECONDS_SINCE_EPOCH", new Date(0));
    ...
    public static AccessToken createAccessTokenFromWebBundle(Collection<String> collection, Bundle bundle, AccessTokenSource accessTokenSource, String str) throws FacebookException {
        Date a = Utility.m5766a(bundle, "expires_in", new Date());
        ...
        Collection arrayList = !Utility.m5785a(string3) ? new ArrayList(Arrays.asList(string3.split(","))) : null;
        if (Utility.m5785a(string) != null) {
            return null;
        }
        return new AccessToken(string, str, getUserIDFromSignedRequest(bundle.getString("signed_request")), collection2, arrayList, accessTokenSource, a, new Date());
    }

    static java.lang.String getUserIDFromSignedRequest(java.lang.String r2) throws com.facebook.FacebookException {
...
*/
    ...
    public void writeToParcel(Parcel parcel, int i) {
        Utility.m5773a(parcel, this.methodLoggingExtras);
    }
}
