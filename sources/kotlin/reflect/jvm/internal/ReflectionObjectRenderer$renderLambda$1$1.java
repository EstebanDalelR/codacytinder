...
@Metadata(bv = {1, 0, 2}, d1 = {"\u0000\u0010\n\u0000\n\u0002\u0010\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\u0010\u0000\u001a\u00020\u00012\u000e\u0010\u0002\u001a\n \u0004*\u0004\u0018\u00010\u00030\u0003H\n¢\u0006\u0002\b\u0005"}, d2 = {"<anonymous>", "", "it", "Lkotlin/reflect/jvm/internal/impl/descriptors/ValueParameterDescriptor;", "kotlin.jvm.PlatformType", "invoke"}, k = 3, mv = {1, 1, 10})
final class ReflectionObjectRenderer$renderLambda$1$1 extends Lambda implements Function1<ValueParameterDescriptor, String> {
    ...
    public final String invoke(ValueParameterDescriptor valueParameterDescriptor) {
        ...
        valueParameterDescriptor = valueParameterDescriptor.getType();
        C2668g.a(valueParameterDescriptor, "it.type");
        return reflectionObjectRenderer.renderType(valueParameterDescriptor);
    }
}
