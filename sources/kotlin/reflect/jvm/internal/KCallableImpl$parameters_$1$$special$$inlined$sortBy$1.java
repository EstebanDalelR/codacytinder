...
public final class KCallableImpl$parameters_$1$$special$$inlined$sortBy$1<T> implements Comparator<T> {
    public final int compare(T t, T t2) {
        return C15798b.m59813a(((KParameter) t).getName(), ((KParameter) t2).getName());
    }
}
