...
public final class EmptyList implements Serializable, List, RandomAccess, KMappedMarker {
    /* renamed from: a */
    public static final EmptyList f54740a = new EmptyList();
    ...
    /* renamed from: a */
    public boolean m64155a(@NotNull Void voidR) {
    ...
    /* renamed from: b */
    public int m64156b(@NotNull Void voidR) {
        C2668g.b(voidR, "element");
        return -1;
    }

    /* renamed from: c */
    public int m64157c(@NotNull Void voidR) {
        C2668g.b(voidR, "element");
        return -1;
    }
    ...
    public final boolean contains(Object obj) {
        return obj instanceof Void ? m64155a((Void) obj) : null;
    }
    ...
    public final int indexOf(Object obj) {
        return obj instanceof Void ? m64156b((Void) obj) : -1;
    }

    public final int lastIndexOf(Object obj) {
        return obj instanceof Void ? m64157c((Void) obj) : -1;
    }
    ...
    public ListIterator listIterator(int i) {
        if (i == 0) {
            return (ListIterator) C17556x.f54757a;
        }
        StringBuilder stringBuilder = new StringBuilder();
