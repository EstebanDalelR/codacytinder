...
class C15875b {
    /* renamed from: a */
    public static final boolean m59926a(char c) {
    ...
    @NotNull
    /* renamed from: b */
    public static final CharCategory m59927b(char c) {
        return CharCategory.Companion.m59912a(Character.getType(c));
    }

    /* renamed from: a */
    public static final int m59924a(char c, int i) {
        return Character.digit(c, i);
    }

    @PublishedApi
    /* renamed from: a */
    public static final int m59925a(int i) {
        if (2 <= i) {
            if (36 >= i) {
                return i;
            }
        ...
        stringBuilder.append(new C18461c(2, 36));
