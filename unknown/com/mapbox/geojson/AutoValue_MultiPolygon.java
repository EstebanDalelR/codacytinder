...
final class AutoValue_MultiPolygon extends $AutoValue_MultiPolygon {
  AutoValue_MultiPolygon(String type, @Nullable BoundingBox bbox,
  ...
  public static final class GsonTypeAdapter extends TypeAdapter<MultiPolygon> {
    ...
    public GsonTypeAdapter(Gson gson) {
      ...
      this.list__list__list__point_adapter = (TypeAdapter<List<List<List<Point>>>>) gson.getAdapter(TypeToken.getParameterized(List.class, TypeToken.getParameterized(List.class, TypeToken.getParameterized(List.class, Point.class).getType()).getType()));
    }
    @Override
